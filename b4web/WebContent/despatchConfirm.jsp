...
<h2>
<%=Lang.getText("dlg_Despatch_Confirm") %><%out.println(session.getAttribute("despatchNo"));%>
</h2><br>
<INPUT TYPE=CHECKBOX NAME="printSTNonConfirm">&nbsp;<%=Lang.getText("web_Print_STN") %>
<br><br><%out.println(session.getAttribute("_ErrorMessage"));%>
