...
<td width="100%" height="20" align="center">
 <input tabindex="3" type="submit" name="buttonSubmit" id="buttonSubmit" value="<%=Lang.getText("web_Submit") %>" onclick="document.palletDelete.button.value='Submit';">&nbsp;
 <input tabindex="4" type="submit" name="buttonCancel" id="buttonCancel" value="<%=Lang.getText("web_Cancel") %>" onclick="document.palletDelete.button.value='Cancel';">
