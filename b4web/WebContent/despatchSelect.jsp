...
<h2><%=Lang.getText("mod_FRM_ADMIN_DESPATCH") %></h2>
<p align="center"><%
...
if (currentDespatchListPage == null) currentDespatchListPage = "1";
if (maxDespatchPages == null) maxDespatchPages = "1";
out.println("Page "+currentDespatchListPage+" of "+maxDespatchPages);
%></p>
<div  align="left"><%
String despatchList = (String) session.getAttribute("despatchList");
if (despatchList == null) despatchList = "";
