...
public class InboundConnectorSFTP extends InboundConnectorABSTRACT
{

	Logger logger = org.apache.logging.log4j.LogManager.getLogger((InboundConnectorSFTP.class));

	public InboundConnectorSFTP(InboundInterface inter)
	{
