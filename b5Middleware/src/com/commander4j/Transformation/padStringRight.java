...
public class padStringRight extends ExtensionFunctionDefinition
{
	...
	{
		return new StructuredQName("c4j_XSLT_Ext", "http://com.commander4j.Transformation", "padStringRight");
	}
