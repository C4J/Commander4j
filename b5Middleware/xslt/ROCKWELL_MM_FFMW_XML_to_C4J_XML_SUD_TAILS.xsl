...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
    ...
    <xsl:variable name="STORAGE_LOCATION"><xsl:value-of select="c4j:getConfigItem('config','StorageLocation')"/></xsl:variable>
    <xsl:variable name="TAILS_COMPANY_ID"><xsl:value-of select="c4j:getConfigItem('config','TailsCompanyID')"/></xsl:variable>
    ...
    <xsl:variable name="STORAGE_BIN_SPACES" select="string(/MESSAGE/DATA[@type='Location']/FIELD[@name='StorageLocation'][@value=$STORAGE_LOCATION]/parent::*/FIELD[@name='Plant'][@value=$PLANT]/parent::*/FIELD[@name='StorageBin']/@value)" />
