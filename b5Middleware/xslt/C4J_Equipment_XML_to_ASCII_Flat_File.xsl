...
<xsl:stylesheet 
	...
	exclude-result-prefixes="xs c4j c4j_XSLT_Ext_subString c4j_XSLT_Ext_padStringLeft c4j_XSLT_Ext_padStringRight"  version="2.0">
	...
	<xsl:template match="/message/messageData/equipmentTracking/contents/Equipment">
		...
		<row >
			...
			<col id="2"><xsl:value-of select="c4j_XSLT_Ext_padStringRight:padStringRight($despatchNo, 8, ' ')" /></col>
			<col id="3"><xsl:value-of select="c4j_XSLT_Ext_subString:subString($despatchDate, 0, 4)" /></col>
			<col id="4"><xsl:value-of select="c4j_XSLT_Ext_subString:subString($despatchDate, 5, 2)" /></col>
			<col id="5"><xsl:value-of select="c4j_XSLT_Ext_subString:subString($despatchDate, 8, 2)" /></col>
			<col id="6"><xsl:value-of select="c4j_XSLT_Ext_subString:subString($despatchDate, 11, 8)" /></col>					
			<col id="7"><xsl:value-of select="$toLocation" /></col>
			<col id="8"><xsl:value-of select="$fromLocation" /></col>	
			<col id="9"><xsl:value-of select="c4j_XSLT_Ext_padStringRight:padStringRight($equipmentID, 2, ' ')" /></col>
			<col id="10"><xsl:value-of select="c4j_XSLT_Ext_padStringRight:padStringRight($count, 6, ' ')" /></col>
			<col id="11"><xsl:value-of select="c4j_XSLT_Ext_padStringRight:padStringRight($haulier, 10, ' ')" /></col>	
		</row>
