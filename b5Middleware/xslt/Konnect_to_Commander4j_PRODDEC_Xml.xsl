...
<xsl:stylesheet 
	...
	xmlns:c4j_XSLT_Ext_getISODateTimeString="http://com.commander4j.Transformation.XSLT_Ext_getISODateTimeString"
	exclude-result-prefixes="xs c4j c4j_XSLT_Ext_getISODateTimeString" version="2.0">
