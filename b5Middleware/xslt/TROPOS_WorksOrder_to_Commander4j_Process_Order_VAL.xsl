...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
	...
	<xsl:template match='xml'>
		  ...
		  <xsl:param name="orderNumber" select='ORDER_NUMBER' />
		  ...
		  <message>
			   ...
			   <messageData>
				  ...
				  <processOrder>
				  	<xsl:variable name="orderNumberShort" select="substring($orderNumber,3,6)"/>
				  	<orderNo><xsl:value-of select='$orderNumberShort'/></orderNo>
