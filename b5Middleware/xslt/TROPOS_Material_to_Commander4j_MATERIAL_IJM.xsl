				...
				<materialDefinition>
					...
					<materialCustomerData>
						<customer>
							...
							<data>
								<xsl:attribute name="dataType">CU_EAN</xsl:attribute>
								<xsl:attribute name="value">
									<xsl:value-of select="EAN_UNIT"/>
								</xsl:attribute>
							</data>
							<data>
								<xsl:attribute name="dataType">CU_QUANTITY</xsl:attribute>
								<xsl:attribute name="value">
									<xsl:value-of select="CASE_UNIT_FAC"/>
								</xsl:attribute>
							</data>
							<data>
								<xsl:attribute name="dataType">CASE_CONTENT</xsl:attribute>
								<xsl:attribute name="value">
									<xsl:value-of select="CASE_CONTENT"/>
								</xsl:attribute>
							</data>
						</customer>
					</materialCustomerData>
