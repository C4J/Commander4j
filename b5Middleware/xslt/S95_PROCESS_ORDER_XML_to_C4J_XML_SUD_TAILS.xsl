...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
    ...
    <xsl:variable name="NOTES" select="/ProductionSchedule/ProductionRequest[1]/SegmentRequirement[1]/globe_Note[1]"/>
        ...
        <message>
            ...
            <messageData>
                <processOrder>
                    ...
                    <customerID><xsl:if test="contains($NOTES,'+TAILS+')">TAILS</xsl:if><xsl:if test="not(contains($NOTES,'+TAILS+'))">SELF</xsl:if></customerID>
                </processOrder>
            </messageData>
        </message>
