		...
		try
		{
			...
			this.setTitle("Waste Location Admin");
			{
				...
				}
				{
					...
					jButtonHelp.setBounds(689, 248, 125, 32);
				}
				{
					...
					jButtonRefresh.setBounds(689, 217, 125, 32);
				...
				}
				{
					...
					jButtonClose.setBounds(689, 279, 125, 32);
...

				{
					...
					jButtonExcel.setBounds(689, 186, 125, 32);
...

				{
					...
					jButtonLabel.setBounds(689, 155, 125, 32);
				...
				panel.setBounds(689, 321, 125, 68);
