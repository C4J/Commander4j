...
public class JDBWasteLocationJList extends JList<JDBListData>
{

	private static final long serialVersionUID = 1;
	private String key;
	private String tooltip;
	private JDBWasteLocation mod;
	...
	public String getToolTipText(MouseEvent e) {
		...
		if (index > -1)
		{
			try
			{
				...
				mod.setWasteLocationID(key);
				if (mod.getWasteLocationProperties() == true)
				{
