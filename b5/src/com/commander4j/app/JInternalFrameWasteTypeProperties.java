...
public class JInternalFrameWasteTypeProperties extends JInternalFrame
{
	...
	private JCheckBox chckbx_Recycle = new JCheckBox("");
	private JCheckBox chckbx_Hazard = new JCheckBox("");
	private JCheckBox chckbx_Enabled = new JCheckBox("");
	private JCheckBox chckbx_PPEReqd = new JCheckBox("");
		...
		try
		{
			...
			this.setTitle("Waste Type Properties");
			{
				...
				jDesktopPane1.setLayout(null);
				{
					...
					jLabel_WasteType.setBounds(0, 10, 149, 21);
				}
				{
					...
					jTextFieldTypeID.setBounds(155, 10, 237, 21);
...

				{
					...
					chckbx_Recycle.setBounds(155, 75, 29, 23);
					jDesktopPane1.add(chckbx_Recycle);
					
					chckbx_Hazard.setBounds(155, 105, 29, 23);
					jDesktopPane1.add(chckbx_Hazard);
					
					chckbx_Enabled.setBounds(155, 165, 29, 23);
					...
					jLabel_Recycle.setBounds(0, 77, 149, 21);
					...
					jLabel_Hazard.setBounds(0, 107, 149, 21);
					...
					jLabel_Enabled.setBounds(0, 167, 149, 21);
					jDesktopPane1.add(jLabel_Enabled);
					

					chckbx_PPEReqd.setSelected(false);
					chckbx_PPEReqd.setBounds(155, 135, 29, 23);
					...
					jLabel_PPEReqd.setBounds(0, 137, 149, 21);
