 ...
 * 
 * Filename     : JDBMHNPalletTableModelProperties.java
 * 
...
public class JDBMHNPalletTableModelProperties extends AbstractTableModel
{
	...
	private String[] mcolNames = { "SSCC", "Material", "Batch", "Process Order", "Quantity", "UOM", "Date of Manufacture", "SSCC Status","Batch Status", "Location", "Decision" };
