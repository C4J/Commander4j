...
public class JFrameCloneDB extends JFrame
{
	...
	public JFrameCloneDB()
	{
		...
		setBounds(screenBounds.x + ((screenBounds.width - JFrameCloneDB.this.getWidth()) / 2), screenBounds.y + ((screenBounds.height - JFrameCloneDB.this.getHeight()) / 2), JFrameCloneDB.this.getWidth()+widthadjustment, JFrameCloneDB.this.getHeight()+heightadjustment);
