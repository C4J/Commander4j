...
public class JInternalFrameBomStructureProperties extends JInternalFrame
{
	...
	private void initGUI()
	{
		try
		{
			...
			jButtonUpdate.setBounds(49, 72, 112, 32);
			...
			jButtonClose.setBounds(313, 72, 112, 32);
			...
			comboBoxDataID.setBounds(143, 40, 282, 22);
			...
			comboBoxParentDataID.setBounds(143, 8, 282, 22);
			...
			jLabel_Data_ID.setBounds(22, 40, 112, 22);
			...
			jLabel_Parent_Data_ID.setBounds(22, 8, 112, 22);
