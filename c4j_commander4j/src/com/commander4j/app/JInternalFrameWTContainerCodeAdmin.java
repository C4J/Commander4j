...
/**
 * The JInternalFrameWTContainerCodeAdmin class allows a user to maintain the
 * table APP_WEIGHT_CONTAINER_CODE.
 *
 * <p>
 * <img alt="" src="./doc-files/JInternalFrameWTContainerCodeAdmin.jpg" >
 *
 * @see com.commander4j.db.JDBWTContainerCode JDBWTContainerCode
 * @see com.commander4j.app.JInternalFrameWTContainerCodeAdmin
 *      JInternalFrameWTContainerCodeAdmin
 *
 */
public class JInternalFrameWTContainerCodeAdmin extends javax.swing.JInternalFrame
{
	...
	private JLabel4j_std jLabel_Title;
	...
	public JInternalFrameWTContainerCodeAdmin()
	{
		...
		{
			jLabel_Title = new JLabel4j_std("Container Code     Description");
			jLabel_Title.setFont(new Font("Monospaced", Font.BOLD, 11));
			jLabel_Title.setBounds(0, 0, 518, 15);
			jDesktopPane1.add(jLabel_Title);
		}
		populateList("");
	}
	...
	private void initGUI()
	{
		try
		{
			...
			jScrollPane1.setBounds(0, 16, 518, 280);
			...
			jButtonAdd.setBounds(519, 16, 125, 32);
			...
			jButtonDelete.setBounds(519, 47, 125, 32);
			...
			jButtonEdit.setBounds(519, 78, 125, 32);
			...
			jButtonRename.setBounds(519, 109, 125, 32);
			...
			jButtonPrint.setBounds(519, 140, 125, 32);
			...
			jButtonClose.setBounds(519, 264, 125, 32);
			...
			jButtonExcel.setBounds(519, 171, 125, 32);
