...
public class JInternalFramePalletProperties extends javax.swing.JInternalFrame
{
	...
	private void initGUI()
	{
		try
		{
			...
			this.setClosable(true);
			{
				...
				jButtonSave.setBounds(2, 525, 113, 32);
				...
				jButtonHelp.setBounds(232, 525, 113, 32);

				jButtonCancel = new JButton4j(Common.icon_close_16x16);
				jDesktopPane1.add(jButtonCancel);
				jButtonCancel.setText(lang.get("btn_Close"));
				jButtonCancel.setMnemonic(lang.getMnemonicChar());
				jButtonCancel.setBounds(347, 525, 113, 32);
				...
				fld_DespatchNo.setBounds(147, 438, 120, 22);
				...
				fld_Material.setBounds(147, 87, 120, 22);
				...
				fld_MaterialBatch.setBounds(147, 141, 120, 22);
				...
				btn_MaterialBatch.setBounds(268, 141, 21, 22);
				...
				fld_Location.setBounds(147, 222, 120, 22);
				...
				btn_Location.setBounds(268, 222, 21, 22);
				...
				fld_ProcessOrder.setBounds(147, 33, 120, 22);
				...
				btn_ProcessOrder.setBounds(268, 33, 21, 22);
				...
				btn_RefreshProcessOrder.setBounds(289, 33, 21, 22);
				...
				fld_EAN.setBounds(147, 330, 120, 22);
				...
				fld_DOM.setBounds(147, 411, 120, 22);
				...
				btn_BatchExpiry.setBounds(268, 195, 21, 22);
				...
				fld_BatchExpiry.setBounds(147, 195, 120, 22);
				...
				jStatusText.setBounds(5, 565, 450, 21);
				...
				jButtonUndo.setBounds(117, 525, 113, 32);
				...
				calendarButtonproductionDate.setBounds(270, 412, 21, 21);
				...
				fld_Customer.setBounds(147, 357, 120, 22);
				...
				fld_Equipment.setBounds(147, 465, 120, 22);
				...
				jButtonLookupEquipment.setBounds(268, 465, 21, 22);
	...
	private void refresh()
	{
		...
		if (processOrder.getProcessOrderProperties(pallet.getProcessOrder()) == false)
		{
			...
			fld_ProcessOrderDescription.setText(processOrder.getErrorMessage());
		}
		else
		{
			fld_ProcessOrderDescription.setText(processOrder.getDescription());
		...
		if (material.getMaterialProperties(pallet.getMaterial())==false)
		{
			if (valid)
			{
				msg = material.getErrorMessage();
				valid = false;
			}
			fld_MaterialDescription.setText(material.getErrorMessage());
		}
		else
		{
			fld_MaterialDescription.setText(material.getDescription());
