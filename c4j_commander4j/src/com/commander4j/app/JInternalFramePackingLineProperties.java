...
public class JInternalFramePackingLineProperties extends JInternalFrame
{
	...
	private void initGUI()
	{
		try
		{
			...
			jLabel_PackingLineID.setBounds(12, 8, 129, 22);
			...
			jTextFieldPackingLineID.setBounds(148, 8, 170, 22);
			...
			jLabelDescription.setBounds(12, 40, 129, 22);
			...
			jTextFieldDescription.setBounds(148, 40, 265, 22);
			...
			jButtonUpdate.setBounds(38, 104, 123, 32);
			...
			jButtonHelp.setBounds(164, 104, 123, 32);
			jDesktopPane1.add(jButtonHelp);
			jButtonHelp.setText(lang.get("btn_Help"));
			jButtonHelp.setMnemonic(lang.getMnemonicChar());

			jButtonClose = new JButton4j(Common.icon_close_16x16);
			jButtonClose.setBounds(290, 104, 123, 32);
			...
			label_Enabled.setBounds(12, 72, 129, 22);
			...
			chckbxEnabled.setBounds(148, 72, 21, 22);
