...
/**
 * The JInternalFrameMaterialUomProperties is the screen for editing a single
 * unit of measure record for a Material in the APP_MATERIAL_UOM table.
 *
 * <p>
...
public class JInternalFrameMaterialUomProperties extends JInternalFrame
{
	...
	private JLabel4j_status status = new JLabel4j_status();
	...
	public JInternalFrameMaterialUomProperties()
	{
		...
		SwingUtilities.invokeLater(new Runnable()
		{
			public void run()
			{
				...
				status.setBounds(11, 275, 379, 21);
	...
	private void initGUI()
	{
		try
		{
			...
			jButtonUpdate.setBounds(11, 232, 120, 32);
			...
			jButtonHelp.setBounds(141, 232, 120, 32);
			...
			jButtonCancel.setBounds(271, 232, 120, 32);
			...
			jLabel2.setBounds(11, 72, 147, 22);
			...
			jLabel3.setBounds(11, 104, 147, 22);
			...
			jLabel4.setBounds(11, 136, 147, 22);
			...
			jLabel5.setBounds(11, 168, 147, 22);
			...
			jLabel6.setBounds(11, 40, 147, 22);
			...
			jTextFieldMaterial.setBounds(165, 8, 113, 22);
			...
			jTextFieldUOM.setBounds(165, 40, 60, 22);
			...
			jTextFieldEAN.setBounds(165, 72, 175, 22);
			...
			jTextFieldVariant.setBounds(165, 104, 34, 22);
			...
			jSpinnerDenominator.setBounds(165, 168, 75, 22);
			...
			jSpinnerNumerator.setBounds(165, 136, 75, 22);
			...
			lbl_Override.setBounds(11, 200, 147, 22);
			...
			chckbxOverride.setBounds(165, 200, 25, 22);
