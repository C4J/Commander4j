...
/**
 * The JInternalFrameWTSamplePointAdmin class allows a user to maintain the
 * table APP_WEIGHT_SAMPLE_POINT.
 *
 * <p>
 * <img alt="" src="./doc-files/JInternalFrameWTSamplePointAdmin.jpg" >
 *
 * @see com.commander4j.db.JDBWTSamplePoint JDBWTSamplePoint
 * @see com.commander4j.app.JInternalFrameWTSamplePointAdmin
 *      JInternalFrameWTSamplePointAdmin
 *
 */
public class JInternalFrameWTSamplePointAdmin extends javax.swing.JInternalFrame
{
	...
	public JInternalFrameWTSamplePointAdmin()
	{
		...
		help.enableHelpOnButton(jButtonHelp, JUtility.getHelpSetIDforModule("FRM_WEIGHT_SAMPLEPOINT"));
		{
			...
			lblSamplePointDescription.setBounds(0, 0, 659, 15);
	...
	private void initGUI()
	{
		try
		{
			...
			jScrollPane1.setBounds(0, 13, 686, 400);
			...
			jButtonAdd.setBounds(687, 13, 125, 32);
			...
			jButtonDelete.setBounds(687, 44, 125, 32);
			...
			jButtonEdit.setBounds(687, 75, 125, 32);
			...
			jButtonRename.setBounds(687, 106, 125, 32);
			...
			jButtonPrint.setBounds(687, 137, 125, 32);
			...
			jButtonClose.setBounds(687, 261, 125, 32);
			...
			jButtonExcel.setBounds(687, 168, 125, 32);
