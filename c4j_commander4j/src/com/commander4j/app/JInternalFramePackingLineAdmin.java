...
public class JInternalFramePackingLineAdmin extends JInternalFrame
{
	...
	private void initGUI()
	{
		try
		{
			...
			jButtonAdd.setBounds(418, 0, 126, 32);
			...
			jButtonDelete.setBounds(418, 31, 126, 32);
			...
			jButtonEdit.setBounds(418, 62, 126, 32);
			...
			jButtonPrint.setBounds(418, 94, 126, 32);
			...
			jButtonClose.setBounds(418, 187, 126, 32);
			...
			panel.setBounds(418, 231, 125, 68);
