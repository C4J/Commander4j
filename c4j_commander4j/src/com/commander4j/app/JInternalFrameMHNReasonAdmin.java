...
/**
 * JInternalFrameMHNReasonAdmin class allows the user to insert/update/delete
 * the APP_MHN_REASONS table.
 * <p>
 * <img alt="" src="./doc-files/JInternalFrameMHNReasonAdmin.jpg" >
 *
 * @see com.commander4j.app.JInternalFrameMHNReasonProperties
 *      JInternalFrameMHNReasonProperties
	...
	private void initGUI()
	{
		try
		{
			...
			this.setTitle("Reason Admin");
			{
				...
				jButtonAdd.setBounds(375, 0, 126, 32);
				...
				jButtonDelete.setBounds(375, 31, 126, 32);
				...
				jButtonEdit.setBounds(375, 62, 126, 32);
				...
				jButtonRename.setBounds(375, 93, 126, 32);
				...
				jButtonPrint.setBounds(375, 124, 126, 32);
				...
				jButtonClose.setBounds(375, 218, 126, 32);
