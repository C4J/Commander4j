...
public class JInternalFrameQMSelectListAdmin extends javax.swing.JInternalFrame
{
	...
	private void initGUI()
	{
		try
		{
			...
			jButtonAdd.setBounds(652, 0, 125, 32);
			...
			jButtonDelete.setBounds(652, 31, 125, 32);
			...
			jButtonEdit.setBounds(652, 62, 125, 32);
			...
			jButtonRefresh.setBounds(652, 93, 125, 32);
			...
			jButtonClose.setBounds(652, 155, 125, 32);
			...
			btnExcel.setBounds(652, 122, 125, 32);
