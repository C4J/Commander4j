 ...
 *
 * Filename     : JInternalFrameMaterialLocationProperties.java
 *
...
public class JInternalFrameMaterialLocationProperties extends JInternalFrame
{
	...
	private void initGUI()
	{
		try
		{
			...
			jButtonUpdate.setBounds(17, 107, 112, 32);
			...
			jButtonHelp.setBounds(130, 107, 112, 32);

			jButtonCancel = new JButton4j(Common.icon_close_16x16);
			jDesktopPane1.add(jButtonCancel);
			jButtonCancel.setText(lang.get("btn_Close"));
			jButtonCancel.setMnemonic(lang.getMnemonicChar());
			jButtonCancel.setBounds(243, 107, 112, 32);
			...
			jTextFieldMaterial.setText(lmaterial);
			jTextFieldMaterial.setBounds(126, 8, 126, 21);
			...
			jTextFieldLocation.setText(llocation);
			jTextFieldLocation.setBounds(126, 40, 126, 21);
			...
			jComboBoxStatus.setBounds(126, 72, 190, 23);
