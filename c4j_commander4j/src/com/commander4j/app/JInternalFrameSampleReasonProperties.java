...
/**
 * JInternalFrameMHNReasonProperties class allows the user to edit a single
 * record in the APP_MHN_REASONS table.
 * <p>
 * <img alt="" src="./doc-files/JInternalFrameMHNReasonProperties.jpg" >
 *
 * @see com.commander4j.app.JInternalFrameMHNReasonAdmin
 *      JInternalFrameMHNReasonAdmin
...
public class JInternalFrameSampleReasonProperties extends JInternalFrame
{
	...
	private JLabel4j_std jLabel_Enable;
	...
	private void initGUI()
	{
		try
		{
			...
			jLabel_Reason.setBounds(0, 8, 98, 22);
			jDesktopPane1.add(jLabel_Reason);
			jLabel_Reason.setText(lang.get("lbl_Reason"));
			jLabel_Reason.setHorizontalAlignment(SwingConstants.RIGHT);
			jLabel_Reason.setHorizontalTextPosition(SwingConstants.RIGHT);

			jLabel_Enable = new JLabel4j_std();
			jLabel_Enable.setBounds(0, 72, 98, 22);
			jDesktopPane1.add(jLabel_Enable);
			jLabel_Enable.setText(lang.get("lbl_Enabled"));
			jLabel_Enable.setHorizontalAlignment(SwingConstants.RIGHT);
			jLabel_Enable.setHorizontalTextPosition(SwingConstants.RIGHT);

			jTextFieldReason = new JTextField4j(JDBSampleReasons.field_sample_reason);
			jTextFieldReason.setBounds(110, 8, 80, 22);
			...
			jLabel_Description.setBounds(0, 40, 98, 22);
			...
			jTextFieldDescription.setBounds(110, 40, 238, 22);
			...
			jButtonUpdate.setBounds(26, 110, 112, 32);
			...
			jButtonHelp.setBounds(138, 110, 112, 32);
			jDesktopPane1.add(jButtonHelp);
			jButtonHelp.setText(lang.get("btn_Help"));
			jButtonHelp.setMnemonic(lang.getMnemonicChar());

			jButtonClose = new JButton4j(Common.icon_close_16x16);
			jButtonClose.setBounds(251, 110, 112, 32);
			...
			chckbxEnabled.setBounds(110, 72, 22, 22);
