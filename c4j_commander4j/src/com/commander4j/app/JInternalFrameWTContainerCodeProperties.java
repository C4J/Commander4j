...
/**
 * The JInternalFrameWTContainerCodeProperties class allows the user to edit a
 * record in the APP_WEIGHT_CONTAINER-CODE table.
 *
 * <p>
...
public class JInternalFrameWTContainerCodeProperties extends JInternalFrame
{
	...
	private void initGUI()
	{
		try
		{
			...
			jLabel_ContainerCode.setBounds(0, 8, 149, 22);
			...
			jTextFieldContainerCode.setBounds(155, 8, 237, 22);
			...
			jButtonSave.setBounds(45, 72, 110, 32);
			...
			jButtonHelp.setBounds(157, 72, 110, 32);

			jButtonClose = new JButton4j(Common.icon_close_16x16);
			jDesktopPane1.add(jButtonClose);
			jButtonClose.setText(lang.get("btn_Close"));
			jButtonClose.setMnemonic(lang.getMnemonicChar());
			jButtonClose.setBounds(269, 72, 110, 32);
