...
/**
 * The JInternalFrameWTTNEAdmin class allows a user to maintain the table
 * APP_WEIGHT_TNE.
 *
 * <p>
...
public class JInternalFrameWTTNEAdmin extends javax.swing.JInternalFrame
{
	...
	private void initGUI()
	{
		try
		{
			...
			jScrollPane1.setBounds(0, 16, 518, 276);
			...
			jButtonPrint.setBounds(519, 109, 125, 32);
			...
			jButtonClose.setBounds(519, 233, 125, 32);
			...
			jButtonExcel.setBounds(519, 140, 125, 32);
			...
			lbl_Legend.setBounds(0, 0, 518, 15);
