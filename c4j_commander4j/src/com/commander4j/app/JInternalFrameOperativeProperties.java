...
public class JInternalFrameOperativeProperties extends JInternalFrame
{
	...
	private void initGUI()
	{
		try
		{
			...
			jTextFieldID.setBounds(105, 8, 100, 22);
			...
			jLabelSurname.setBounds(0, 72, 98, 22);
			...
			jTextFieldSurname.setBounds(104, 72, 238, 22);
			...
			label_Enabled.setBounds(0, 104, 97, 22);
			...
			chckbxEnabled.setBounds(105, 104, 21, 22);
