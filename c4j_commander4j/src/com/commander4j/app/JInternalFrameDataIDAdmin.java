...
public class JInternalFrameDataIDAdmin extends JInternalFrame
{
	...
	private void initGUI()
	{
		try
		{
			setPreferredSize(new java.awt.Dimension(375, 402));
			setBounds(0, 0, 505, 415);
			setVisible(true);
			setClosable(true);
			setIconifiable(true);
			setTitle("Customer Moterial Data IDS");
			...
			jButtonAdd.setBounds(367, 1, 126, 32);
			...
			jButtonDelete.setBounds(367, 30, 126, 32);
			...
			jButtonEdit.setBounds(367, 59, 126, 32);
			...
			;
			jButtonPrint.setBounds(367, 87, 126, 32);
			...
			jButtonClose.setBounds(367, 176, 126, 32);
