...
public class JInternalFrameMHNReasonProperties extends JInternalFrame
{
	...
	private void initGUI()
	{
		try
		{
			...
			jTextFieldReason.setBounds(126, 8, 80, 22);
			...
			jTextFieldDescription.setBounds(126, 40, 238, 22);
			...
			jButtonUpdate.setBounds(14, 72, 112, 32);
			...
			jButtonHelp.setBounds(133, 72, 112, 32);
			...
			jButtonClose.setBounds(252, 72, 112, 32);
