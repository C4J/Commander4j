...
public class JInternalFrameSampleDefectIDAdmin extends JInternalFrame
{
	...
	private void initGUI()
	{
		try
		{
			...
			jButtonAdd.setBounds(465, 0, 126, 32);
			...
			jButtonDelete.setBounds(465, 31, 126, 32);
			...
			jButtonEdit.setBounds(465, 62, 126, 32);
			...
			jButtonRename.setBounds(465, 93, 126, 32);
			...
			jButtonPrint.setBounds(465, 124, 126, 32);
			...
			jButtonClose.setBounds(465, 218, 126, 32);
			...
			panel.setBounds(465, 258, 125, 68);
