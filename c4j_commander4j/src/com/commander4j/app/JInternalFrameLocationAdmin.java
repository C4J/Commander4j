...
public class JInternalFrameLocationAdmin extends JInternalFrame
{
	...
	private void initGUI()
	{
		try
		{
			...
			jLabel1.setBounds(246, 8, 109, 22);
			...
			jScrollPane1.setBounds(0, 145, 990, 355);
			{
				...
				jButtonSearch.setBounds(1, 104, 109, 32);
				...
				jButtonAdd.setBounds(221, 104, 109, 32);
				...
				jButtonEdit.setBounds(331, 104, 109, 32);
				...
				jButtonDelete.setBounds(441, 104, 109, 32);
				...
				jButtonPrint.setBounds(551, 104, 109, 32);
				...
				jButtonHelp.setBounds(771, 104, 109, 32);

				jButtonClose = new JButton4j(Common.icon_close_16x16);
				jDesktopPane1.add(jButtonClose);
				jButtonClose.setText(lang.get("btn_Close"));
				jButtonClose.setMnemonic(lang.getMnemonicChar());
				jButtonClose.setBounds(881, 104, 109, 32);
				...
				jToggleButtonSequence.setBounds(757, 72, 22, 22);
				...
				jStatusText.setBounds(5, 505, 985, 21);
