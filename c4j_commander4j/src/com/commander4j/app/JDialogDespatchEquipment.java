...
public class JDialogDespatchEquipment extends javax.swing.JDialog
{
	...
	private void initGUI()
	{
		try
		{
			...
			JScrollPane4j scrollPanelDespatchEquipment = new JScrollPane4j(JScrollPane4j.List);
			...
			panel_1.setBorder(JTitledBorder4j.getPanelTitledBorder("Equipment"));
			...
			jStatusText.setBounds(12, 310, 299, 21);
