...
public class JDialogDataIDProperties extends javax.swing.JDialog
{
	...
	private JLabel4j_std jLabel_Data_ID;
	...
	public JDialogDataIDProperties(JFrame frame, String typ)
	{
		...
		desktopPane.setBounds(0, 0, 469, 137);
	...
	private void initGUI()
	{
		try
		{
			...
			jLabel_Data_ID = new JLabel4j_std();
			desktopPane.add(jLabel_Data_ID, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
			...
			jLabel_Data_ID.setBounds(6, 8, 144, 22);
			...
			jTextFieldType.setBounds(158, 8, 272, 22);

			jLabel_Description = new JLabel4j_std();
			desktopPane.add(jLabel_Description, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
			...
			jLabel_Description.setBounds(6, 40, 144, 22);
			...
			jTextFieldDescription.setBounds(158, 40, 272, 22);
			...
			jButtonUpdate.setBounds(68, 72, 112, 32);
			...
			jButtonHelp.setBounds(182, 72, 112, 32);
			...
			jButtonClose.setBounds(296, 72, 112, 32);
