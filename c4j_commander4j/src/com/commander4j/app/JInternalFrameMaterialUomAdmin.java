...
/**
 * The JInternalFrameMaterialUomAdmin is the screen for editing the units of
 * measure which exist for the Material. For example a can of petfood can exist
 * as a single can (Each), Case, Layer on Pallet or whole Pallet.
 *
 * <p>
 * <img alt="" src="./doc-files/JInternalFrameMaterialUomAdmin.jpg" >
 *
 * @see com.commander4j.app.JInternalFrameMaterialUomProperties
 *      JInternalFrameMaterialUomProperties
...
public class JInternalFrameMaterialUomAdmin extends javax.swing.JInternalFrame
{
	...
	private void initGUI()
	{
		try
		{
			...
			jScrollPane1.setBounds(0, 0, 563, 224);
			{
			...
			jButtonAdd.setBounds(564, 0, 126, 32);
			...
			jButtonEdit.setBounds(564, 32, 126, 32);
			...
			jButtonDelete.setBounds(564, 64, 126, 32);
			...
			jButtonPrint.setBounds(564, 96, 126, 32);
			...
			jButtonHelp.setBounds(564, 160, 126, 32);

			jButtonClose = new JButton4j(Common.icon_close_16x16);
			jDesktopPane1.add(jButtonClose);
			jButtonClose.setText(lang.get("btn_Close"));
			jButtonClose.setMnemonic(lang.getMnemonicChar());
			jButtonClose.setBounds(564, 192, 126, 32);
			...
			jButtonRefresh.setBounds(564, 128, 126, 32);
			...
			jStatusBar.setBounds(5, 230, 680, 21);
