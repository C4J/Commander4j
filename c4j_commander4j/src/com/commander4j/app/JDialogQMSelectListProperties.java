...
/**
 * JDialogQMSelectListProperties is used to administer a single record within
 * the APP_QM_SELECTLIST table.
 *
 * <p>
...
public class JDialogQMSelectListProperties extends javax.swing.JDialog
{
	...
	public JDialogQMSelectListProperties(JFrame frame, String listid, String val)
	{
		...
		lblValue.setBounds(220, 8, 89, 22);
		...
		textFieldListID.setBounds(103, 8, 117, 22);
		...
		btnSave.setBounds(103, 106, 117, 32);
		...
		btnClose.setBounds(225, 106, 117, 32);
		...
		textFieldDescription.setBounds(103, 40, 286, 22);
		...
		spinnerSequence.setBounds(103, 72, 60, 22);
		...
		lblVisible.setBounds(257, 72, 92, 22);
		...
		chckbxVisible.setBounds(361, 71, 28, 23);
