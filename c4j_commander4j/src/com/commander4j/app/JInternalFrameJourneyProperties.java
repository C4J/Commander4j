 ...
 *
 * Filename     : JInternalFrameJourneyProperties.java
 *
...
public class JInternalFrameJourneyProperties extends JInternalFrame
{
	...
	private void initGUI()
	{
		try
		{
			...
			jButtonUpdate.setBounds(63, 264, 112, 32);
			...
			jButtonHelp.setBounds(175, 264, 112, 32);

			jButtonCancel = new JButton4j(Common.icon_close_16x16);
			jDesktopPane1.add(jButtonCancel);
			jButtonCancel.setText(lang.get("btn_Close"));
			jButtonCancel.setMnemonic(lang.getMnemonicChar());
			jButtonCancel.setBounds(287, 264, 112, 32);
			...
			jTextFieldJourneyRef.setBounds(174, 8, 126, 22);
			...
			ComboBoxModel<String> jComboBoxStatusModel = new DefaultComboBoxModel<String>(Common.JourneyRefStatus);
			jComboBoxStatus = new JComboBox4j<String>();
			jDesktopPane1.add(jComboBoxStatus);
			jComboBoxStatus.setModel(jComboBoxStatusModel);
			jComboBoxStatus.setBounds(174, 72, 150, 22);
			...
			jLabelStatus.setBounds(0, 72, 167, 22);

			jStatusText = new JLabel4j_status();
			jStatusText.setBounds(6, 304, 452, 21);
			...
			jLabelLocation.setBounds(0, 104, 167, 22);
			...
			jTextFieldLocation.setBounds(174, 104, 128, 22);
			...
			button4j.setBounds(303, 104, 21, 22);
			...
			jLabelTimeslot.setBounds(0, 136, 167, 22);
			...
			dateControlTimeslot.setBounds(174, 136, 120, 22);
			...
			calendarButton.setBounds(302, 137, 21, 21);
			...
			jLabelHaulier.setBounds(0, 232, 167, 22);
			...
			jLabelLoadTypeDesc.setBounds(0, 200, 167, 22);
			...
			jLabelLoadType.setBounds(0, 168, 167, 22);
			...
			jTextFieldLoadType.setBounds(174, 168, 126, 22);
			...
			jTextFieldLoadTypeDesc.setBounds(174, 200, 281, 22);
			...
			jTextFieldHaulier.setBounds(174, 232, 225, 22);
