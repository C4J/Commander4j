 ...
 * record in the APP_WASTE_TYPES table.
 *
 * <p>
...
public class JInternalFrameWasteTypeProperties extends JInternalFrame
{
	...
	private void initGUI()
	{
		try
		{
			...
			this.setBounds(25, 25, 624, 273);
			setVisible(true);
			this.setTitle("Waste Type Properties");

			jDesktopPane1 = new JDesktopPane4j();
			jDesktopPane1.setBackground(Common.color_app_window_properties);
			...
			jLabel_WasteType.setBounds(0, 8, 149, 22);
			...
			jTextFieldTypeID.setBounds(155, 8, 237, 22);
			...
			jButtonSave.setBounds(140, 200, 110, 32);
			...
			jButtonHelp.setBounds(252, 200, 110, 32);

			jButtonClose = new JButton4j(Common.icon_close_16x16);
			jDesktopPane1.add(jButtonClose);
			jButtonClose.setText(lang.get("btn_Close"));
			jButtonClose.setMnemonic(lang.getMnemonicChar());
			jButtonClose.setBounds(363, 200, 110, 32);
			...
			jTextFieldDescription.setBounds(155, 40, 433, 22);
			...
			chckbx_Recycle.setBounds(155, 72, 29, 22);
			jDesktopPane1.add(chckbx_Recycle);

			chckbx_Hazard.setBounds(155, 104, 29, 22);
			jDesktopPane1.add(chckbx_Hazard);

			chckbx_Enabled.setBounds(155, 168, 29, 22);
			...
			jLabel_Recycle.setBounds(0, 72, 149, 22);
			...
			jLabel_Hazard.setBounds(0, 104, 149, 22);
			...
			jLabel_Enabled.setBounds(0, 168, 149, 22);
			jDesktopPane1.add(jLabel_Enabled);

			chckbx_PPEReqd.setSelected(false);
			chckbx_PPEReqd.setBounds(155, 136, 29, 22);
			...
			jLabel_PPEReqd.setBounds(0, 136, 149, 22);
