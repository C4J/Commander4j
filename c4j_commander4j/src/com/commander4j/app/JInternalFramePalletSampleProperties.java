...
public class JInternalFramePalletSampleProperties extends JInternalFrame
{
	...
	private JPanel4j panelDefectID = new JPanel4j();
	private JPanel4j panelDefectType = new JPanel4j();
	private JPanel4j panelReason = new JPanel4j();
	...
	public JInternalFramePalletSampleProperties(String sscc, Long sequence)
	{
		...
		JLabel4j_title jLabelLane1 = new JLabel4j_title();
		jLabelLane1.setForeground(Common.color_panel_title);

		jLabelLane1.setText(lang.get("lbl_Lane") + " 1");
		jLabelLane1.setHorizontalAlignment(SwingConstants.TRAILING);
		jLabelLane1.setBounds(104, 264, 51, 22);
		jDesktopPane1.add(jLabelLane1);

		JLabel4j_title jLabelLane2 = new JLabel4j_title();
		jLabelLane2.setForeground(Common.color_panel_title);

		jLabelLane2.setText(lang.get("lbl_Lane") + " 2");
		jLabelLane2.setHorizontalAlignment(SwingConstants.TRAILING);
		jLabelLane2.setBounds(217, 264, 51, 22);
		jDesktopPane1.add(jLabelLane2);

		JLabel4j_title jLabelLane3 = new JLabel4j_title();
		jLabelLane3.setForeground(Common.color_panel_title);

		jLabelLane3.setText(lang.get("lbl_Lane") + " 3");
		jLabelLane3.setHorizontalAlignment(SwingConstants.TRAILING);
		jLabelLane3.setBounds(330, 264, 51, 22);
		jDesktopPane1.add(jLabelLane3);

		JLabel4j_title jLabelLane4 = new JLabel4j_title();
		jLabelLane4.setForeground(Common.color_panel_title);

		jLabelLane4.setText(lang.get("lbl_Lane") + " 4");
		jLabelLane4.setHorizontalAlignment(SwingConstants.TRAILING);
		jLabelLane4.setBounds(443, 264, 51, 22);
		jDesktopPane1.add(jLabelLane4);

		JLabel4j_title jLabelLane5 = new JLabel4j_title();
		jLabelLane5.setForeground(Common.color_panel_title);

		jLabelLane5.setText(lang.get("lbl_Lane") + " 5");
		jLabelLane5.setHorizontalAlignment(SwingConstants.TRAILING);
		jLabelLane5.setBounds(556, 264, 51, 22);
		jDesktopPane1.add(jLabelLane5);

		JLabel4j_title jLabelEquals = new JLabel4j_title();
		jLabelEquals.setText("=");
		jLabelEquals.setHorizontalAlignment(SwingConstants.CENTER);
		jLabelEquals.setForeground(Common.color_panel_title);

		jLabelEquals.setBounds(673, 264, 27, 22);
		jDesktopPane1.add(jLabelEquals);

		jLabelSum.setText("0.000");
		jLabelSum.setHorizontalAlignment(SwingConstants.LEFT);
		jLabelSum.setForeground(Common.color_panel_title);

		jLabelSum.setBounds(699, 264, 80, 22);
	...
	private void initGUI()
	{
		try
		{

			{
				...
				jButtonSave.setBounds(180, 392, 112, 32);
				jButtonSave.setEnabled(false);
				...
				jLabel_SSCC.setBounds(5, 8, 144, 22);
				...
				jTextFieldSSCC.setBounds(163, 8, 126, 22);
				...
				jLabelDefectType.setBounds(5, 141, 144, 22);
				...
				jLabelDefectID.setBounds(5, 173, 144, 22);
				...
				lblUserID.setBounds(5, 360, 144, 22);
				...
				jLabel_Sample_Date.setBounds(5, 40, 144, 22);
				...
				jLabel_Sample_Point.setBounds(5, 72, 144, 22);
				...
				jSpinnerSampleDate.setBounds(163, 40, 128, 22);
				...
				jLabelReason.setBounds(5, 109, 144, 22);

				jButtonHelp = new JButton4j(Common.icon_help_16x16);
				jDesktopPane1.add(jButtonHelp);
				jButtonHelp.setText(lang.get("btn_Help"));
				jButtonHelp.setBounds(406, 392, 112, 32);

				jButtonClose = new JButton4j(Common.icon_close_16x16);
				jDesktopPane1.add(jButtonClose);
				jButtonClose.setText(lang.get("btn_Close"));
				jButtonClose.setBounds(520, 392, 112, 32);
				...
				jFormattedTextFieldSampleQuantity.setBounds(163, 232, 50, 22);
				...
				jFormattedTextFieldLane1Quantity.setBounds(162, 264, 50, 22);
				...
				jFormattedTextFieldLane2Quantity.setBounds(275, 264, 50, 22);
				...
				jFormattedTextFieldLane3Quantity.setBounds(388, 264, 50, 22);
				...
				jFormattedTextFieldLane4Quantity.setBounds(501, 264, 50, 22);
				...
				jFormattedTextFieldLane5Quantity.setBounds(615, 264, 50, 22);
				...
				jLabelSampleQuantity.setBounds(5, 232, 144, 22);
				...
				lblLeaking.setBounds(5, 200, 144, 22);
				...
				checkBoxLeaking.setBounds(163, 200, 21, 22);
				...
				jTextFieldFiller_ID.setBounds(163, 72, 106, 22);
				...
				jTextFieldOperative.setBounds(163, 328, 106, 22);
				...
				jButtonLookup_Filler_ID.setBounds(270, 72, 21, 22);
				...
				jButtonLookup_Operative.setBounds(270, 328, 21, 22);
				...
				panelReason.setBounds(163, 104, 502, 27);
				...
				jButtonNotifyEmail.setBounds(293, 392, 112, 32);
				jDesktopPane1.add(jButtonNotifyEmail);

				panelDefectID.setBounds(163, 168, 502, 27);
				jDesktopPane1.add(panelDefectID);
				panelDefectID.setLayout(null);

				panelDefectType.setBounds(163, 136, 502, 27);
	...
	private boolean validateInput()
	{
		...
		{
			jTextFieldOperative.setBackground(Common.color_app_window);
			...
			{
				jTextFieldFiller_ID.setBackground(Common.color_app_window);
				...
				{
					// Reason is present
					panelReason.setBackground(Common.color_app_window);
					...
					if (jComboBoxDefectID.getSelectedItem().toString().equals(""))
					{
						...
						if (zeroQuantity)
						{
							...
							panelDefectID.setBackground(Common.color_app_window);
						}
						else
						{
						...
						{
							checkBoxLeaking.setBackground(Common.color_app_window);
							panelDefectID.setBackground(Common.color_app_window);
						}
					}
					else
