...
public class JInternalFrameWasteTransactionProperties extends JInternalFrame
{
	...
	private void initGUI()
	{
		try
		{
			...
			jLabel_WasteTransaction.setBounds(0, 8, 149, 22);
			...
			jTextFieldTransactionType.setBounds(155, 8, 237, 22);
			...
			jButtonSave.setBounds(146, 168, 110, 32);
			...
			jButtonHelp.setBounds(258, 168, 110, 32);

			jButtonClose = new JButton4j(Common.icon_close_16x16);
			jDesktopPane1.add(jButtonClose);
			jButtonClose.setText(lang.get("btn_Close"));
			jButtonClose.setMnemonic(lang.getMnemonicChar());
			jButtonClose.setBounds(369, 168, 110, 32);
			...
			chckbx_IncludeInTotals.setBounds(155, 72, 29, 22);
			jDesktopPane1.add(chckbx_IncludeInTotals);

			chckbx_StoreAsNegative.setBounds(155, 104, 29, 22);
			jDesktopPane1.add(chckbx_StoreAsNegative);

			chckbx_Enabled.setBounds(155, 136, 29, 22);
			...
			jLabel_IncludeInTotals.setBounds(0, 72, 149, 22);
			...
			jLabel_StoreAsNegative.setBounds(0, 104, 149, 22);
			...
			jLabel_Enabled.setBounds(0, 136, 149, 22);
