...
/**
 * The JInternalFrameMaterialCustomerDataAdmin is the admin screen for
 * Administering Material Data which is customer specific. To edit a specific
 * item of data the dialog JDialogMaterialCustomerDataProperties is used.
 *
 * <p>
 ...
 * @see com.commander4j.app.JDialogMaterialCustomerDataProperties
 *      JDialogMaterialCustomerDataProperties
 */
public class JInternalFrameMaterialCustomerDataAdmin extends javax.swing.JInternalFrame
{
	...
	private void initGUI()
	{
		try
		{
			...
			jScrollPane1.setBounds(0, 7, 812, 319);
			...
			jButtonAdd.setBounds(0, 331, 114, 32);
			...
			jButtonEdit.setBounds(116, 331, 114, 32);
			...
			jButtonDelete.setBounds(232, 331, 114, 32);
				...
				public void actionPerformed(ActionEvent evt)
				{
					...
					if (row >= 0)
					{
						...
						if (question == 0)
						{
							...
							{
								JUtility.errorBeep();
								JOptionPane.showMessageDialog(Common.mainForm, m.getErrorMessage(), "Delete error Material Customer Data  [" + lmaterial + "] Customer [" + lcustomer + "]  Data ID [" + ldataid + "]", JOptionPane.WARNING_MESSAGE);
							}
							else
							{
								populateList(lmaterial);
			...
			jButtonPrint.setBounds(348, 331, 114, 32);
			...
			jButtonPrint.addActionListener(new ActionListener()
			{
				public void actionPerformed(ActionEvent evt)
				{
					...
					JLaunchReport.runReport("RPT_MATERIAL_CUST_DATA", null, JUtility.substSchemaName(schemaName, "select * from {schema}APP_MATERIAL_CUSTOMER_DATA where material = \'" + lmaterial + "\' order by material,customer,data_id"), null, "");
				}
			});
			...
			jButtonHelp.setBounds(580, 331, 114, 32);

			jButtonClose = new JButton4j(Common.icon_close_16x16);
			jDesktopPane1.add(jButtonClose);
			jButtonClose.setText(lang.get("btn_Close"));
			jButtonClose.setMnemonic(lang.getMnemonicChar());
			jButtonClose.setBounds(696, 331, 114, 32);
			...
			jButtonRefresh.setBounds(464, 331, 114, 32);
			...
			jStatusBar.setBounds(5, 370, 805, 21);
