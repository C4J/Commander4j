...
/**
 * JInternalFrameMaterialTypeAdmin allows you to administer the records held in
 * the APP_MATERIAL_TYPE table. This table is provided so Materials can be
 * grouped into types for reporting purposes. Records are typically added
 * automatically by the inbound Material Master interface.
 *
 * <p>
...
public class JInternalFrameMaterialTypeAdmin extends JInternalFrame
{
	...
	private void initGUI()
	{
		try
		{
			...
			jButtonAdd.setBounds(242, 0, 126, 32);
			...
			jButtonDelete.setBounds(242, 31, 126, 32);
			...
			jButtonEdit.setBounds(242, 62, 126, 32);
			...
			jButtonRename.setBounds(242, 93, 126, 32);
			...
			;
			jButtonPrint.setBounds(242, 124, 126, 32);
			...
			jButtonClose.setBounds(242, 217, 126, 32);
