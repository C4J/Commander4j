...
public class JInternalFramePalletSample extends javax.swing.JInternalFrame
{
	...
	private JScrollPane4j scrollPane1 = new JScrollPane4j(JScrollPane4j.Table);
	...
	private void initGUI()
	{
		try
		{
...

			{
				...
				JPanel4j panel_Pallet = new JPanel4j();
				panel_Pallet.setBorder(JTitledBorder4j.getPanelTitledBorder("Pallet Information"));
				...
				jTextFieldLocation.setBounds(835, 28, 120, 22);
				...
				expiryDate.setBounds(835, 58, 120, 22);
				...
				productionDate.setBounds(579, 58, 120, 22);
				...
				jStatusText.setBounds(5, 570, 975, 21);
				...
				jTextFieldMHNDecision.setBounds(835, 117, 120, 22);
				...
				JPanel4j panel_Pallet_Extension = new JPanel4j();
				panel_Pallet_Extension.setBorder(JTitledBorder4j.getPanelTitledBorder("Additional Data"));
				...
				jTextFieldSampleLocation.setBounds(145, 62, 99, 22);
				...
				jTextFieldIncident_Ref.setEnabled(false);
				jTextFieldIncident_Ref.setBounds(420, 62, 120, 22);
				...
				checkBoxFirstCaseInput.setBackground(Common.color_app_window);
				...
				jButtonLookup_SampleLocation.setBounds(244, 62, 21, 22);
				...
				JPanel4j panel_SampleResults = new JPanel4j();
				panel_SampleResults.setBorder(JTitledBorder4j.getPanelTitledBorder("Results"));
	...
	private boolean validateInput()
	{
		...
		{
			valid = false;
			checkBoxFirstCaseInput.setBackGroundColor(error_color);
		}
		else
		{
			checkBoxFirstCaseInput.setBackGroundColor(Common.color_app_window);

			if (checkBoxLastCaseInput.isSelected() == false)
			{
				valid = false;
				checkBoxLastCaseInput.setBackGroundColor(error_color);
			}
			else
			{
				checkBoxLastCaseInput.setBackGroundColor(Common.color_app_window);
