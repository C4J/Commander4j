...
public class JInternalFrameOperativeAdmin extends JInternalFrame
{
	...
	private void initGUI()
	{
		try
		{
			...
			jButtonAdd.setBounds(379, 0, 126, 32);
			...
			jButtonDelete.setBounds(379, 31, 126, 32);
			...
			jButtonEdit.setBounds(379, 62, 126, 32);
			...
			jButtonRename.setBounds(379, 93, 126, 32);
			...
			jButtonPrint.setBounds(379, 124, 126, 32);
			...
			jButtonClose.setBounds(379, 217, 126, 32);
			...
			panel.setBounds(379, 261, 125, 68);
