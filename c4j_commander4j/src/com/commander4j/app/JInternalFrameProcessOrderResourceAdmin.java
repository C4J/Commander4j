...
public class JInternalFrameProcessOrderResourceAdmin extends JInternalFrame
{
	...
	private void buildSQL()
	{
		...
		query.addParamtoSQL("plant_id=", jTextFieldPlantID.getText().toUpperCase());
	...
	private void initGUI()
	{
		try
		{
			...
			jScrollPane1.setBounds(0, 236, 590, 304);
			...
			jButtonSearch.setBounds(0, 168, 145, 32);
			...
			jButtonEdit.setBounds(438, 168, 145, 32);
			...
			jButtonHelp.setBounds(292, 200, 145, 32);

			jButtonClose = new JButton4j(Common.icon_close_16x16);
			jDesktopPane1.add(jButtonClose);
			jButtonClose.setText(lang.get("btn_Close"));
			jButtonClose.setMnemonic(java.awt.event.KeyEvent.VK_C);
			jButtonClose.setBounds(438, 200, 145, 32);
			...
			jLabelResource.setBounds(0, 8, 150, 22);
			...
			jTextFieldDescription.setBounds(154, 40, 341, 22);
			...
			jLabelSortBy.setBounds(0, 136, 150, 22);

			ComboBoxModel<String> jComboBoxSortByModel = new DefaultComboBoxModel<String>(new String[]
			{ "REQUIRED_RESOURCE", "BATCH_SUFFIX", "DESCRIPTION", "ENABLED", "PLANT_ID" });
			jComboBoxSortBy = new JComboBox4j<String>();
			jDesktopPane1.add(jComboBoxSortBy);
			jComboBoxSortBy.setModel(jComboBoxSortByModel);
			jComboBoxSortBy.setBounds(154, 136, 162, 22);
			...
			jLabelBatchSuffix.setBounds(0, 72, 150, 22);

			jToggleButtonSequence = new JToggleButton4j();
			jDesktopPane1.add(jToggleButtonSequence);
			jToggleButtonSequence.setBounds(316, 136, 22, 22);
			...
			jButtonAdd.setBounds(292, 168, 145, 32);
			jDesktopPane1.add(jButtonAdd);

			jStatusText = new JLabel4j_status();
			jStatusText.setBounds(0, 544, 602, 21);
			...
			jButtonExcel.setBounds(146, 200, 145, 32);
			...
			jTextFieldPlantID.setBounds(154, 104, 104, 22);
			...
			jLabelPlantID.setBounds(37, 104, 113, 22);

			jTextFieldBatchSuffix.setBounds(154, 72, 80, 22);
			...
			label4jEnabled.setBounds(234, 72, 135, 22);
			jDesktopPane1.add(label4jEnabled);
			chckbxEnabled.setSelected(true);

			chckbxEnabled.setBounds(373, 72, 29, 22);
			...
			button4jClear.setBounds(146, 168, 145, 32);
			...
			button4jDelete.setBounds(0, 200, 145, 32);
