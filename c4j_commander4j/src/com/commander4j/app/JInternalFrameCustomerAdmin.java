 ...
 *
 * @see com.commander4j.app.JInternalFrameCustomerProperties
 *      JInternalFrameCustomerProperties
...
public class JInternalFrameCustomerAdmin extends javax.swing.JInternalFrame
{
	...
	private void addrecord()
	{
		...
		lcustid = (String) JOptionPane.showInputDialog(Common.mainForm, lang.get("dlg_Customer_Add"), null, JOptionPane.QUESTION_MESSAGE, Common.icon_confirm_16x16, null, null);
		if (lcustid != null)
		{
	...
	private void delete()
	{
		if (jListCustomers.isSelectionEmpty() == false)
		{
			...
			int question = JOptionPane.showConfirmDialog(Common.mainForm, lang.get("dlg_Customer_Delete") + " " + lcustid + " ?", lang.get("dlg_Confirm"), JOptionPane.YES_NO_OPTION, 0, Common.icon_confirm_16x16);
			if (question == 0)
			{
				JDBCustomer u = new JDBCustomer(Common.selectedHostID, Common.sessionID);
				u.setID(lcustid);
	...
	private void initGUI()
	{
		try
		{
			...
			jButtonAdd.setBounds(421, 0, 125, 32);
			...
			jButtonDelete.setBounds(421, 31, 125, 32);
			...
			jButtonEdit.setBounds(421, 62, 125, 32);
			...
			jButtonRename.setBounds(421, 93, 125, 32);
			...
			jButtonPrint.setBounds(421, 124, 125, 32);
			...
			jButtonClose.setBounds(421, 248, 125, 32);
			...
			jButtonExcel.setBounds(421, 155, 125, 32);
