...
public class JInternalFrameProcessOrderAdmin extends JInternalFrame
{
	...
	private JLabel4j_std jLabel_OrderDate;
	private JLabel4j_std jLabel_OrderUOM;
	private JLabel4j_std jLabel_ProcessOrder;
	private JLabel4j_std jLabel_ProcessOrderStatus;
	...
	private void initGUI()
	{
		try
		{
			...
			jDesktopPane1.setPreferredSize(new java.awt.Dimension(757, 468));
			{
				...
				jScrollPane1.setBounds(0, 180, 991, 365);
			...
			jButtonAdd.setBounds(221, 136, 109, 32);
			...
			jButtonEdit.setBounds(331, 136, 109, 32);
			...
			jButtonDelete.setBounds(441, 136, 109, 32);
			...
			jButtonPrint.setBounds(551, 136, 109, 32);
			...
			jButtonLabel.setBounds(661, 136, 109, 32);
			...
			jButtonClose.setBounds(881, 136, 109, 32);
			...
			jLabel_Material.setBounds(278, 40, 87, 22);
			...
			jLabel_Customer.setBounds(278, 8, 87, 22);
			...
			jLabel_Description.setBounds(496, 8, 87, 22);
			...
			jTextFieldDescription.setBounds(589, 8, 395, 22);
			jDesktopPane1.add(jTextFieldDescription);

			jTextFieldMaterial = new JTextField4j(JDBMaterial.field_material);
			jTextFieldMaterial.setBounds(383, 40, 98, 22);
			jDesktopPane1.add(jTextFieldMaterial);

			jTextFieldCustomer = new JTextField4j(JDBCustomer.field_customer_id);
			jTextFieldCustomer.setBounds(383, 8, 98, 22);
			jDesktopPane1.add(jTextFieldCustomer);

			JLabel4j_std jLabel_Inspection = new JLabel4j_std();
			jLabel_Inspection.setText(lang.get("lbl_Inspection_ID"));
			jLabel_Inspection.setHorizontalAlignment(SwingConstants.TRAILING);
			jLabel_Inspection.setBounds(278, 104, 87, 22);
			jDesktopPane1.add(jLabel_Inspection);

			jLabel_Location = new JLabel4j_std();
			jLabel_Location.setBounds(772, 40, 79, 22);
			...
			jTextFieldProcessOrder.setBounds(148, 8, 100, 22);
			jDesktopPane1.add(jTextFieldProcessOrder);

			jLabel_ProcessOrder = new JLabel4j_std();
			jLabel_ProcessOrder.setBounds(3, 8, 110, 22);
			...
			jLabel_ProcessOrderStatus = new JLabel4j_std();
			jLabel_ProcessOrderStatus.setBounds(3, 40, 110, 22);
			jDesktopPane1.add(jLabel_ProcessOrderStatus);
			jLabel_ProcessOrderStatus.setText(lang.get("lbl_Process_Order_Status"));
			jLabel_ProcessOrderStatus.setHorizontalAlignment(SwingConstants.TRAILING);

			jTextFieldLocation = new JTextField4j(JDBLocation.field_location_id);
			jTextFieldLocation.setBounds(857, 40, 105, 22);
			jDesktopPane1.add(jTextFieldLocation);

			jTextFieldRecipe = new JTextField4j(JDBProcessOrder.field_recipe_id);
			jTextFieldRecipe.setBounds(589, 40, 119, 22);
			jDesktopPane1.add(jTextFieldRecipe);

			jTextFieldRecipeVersion = new JTextField4j(JDBProcessOrder.field_recipe_id);
			jTextFieldRecipeVersion.setBounds(726, 40, 41, 22);
			jDesktopPane1.add(jTextFieldRecipeVersion);

			jLabel_SortBy = new JLabel4j_std();
			jLabel_SortBy.setBounds(507, 104, 109, 22);
			...
			dueDateFrom.setBounds(148, 72, 120, 22);
			...
			jLabel_OrderDate = new JLabel4j_std();
			jLabel_OrderDate.setBounds(3, 72, 110, 22);
			jDesktopPane1.add(jLabel_OrderDate);
			jLabel_OrderDate.setText(lang.get("lbl_Process_Order_Due_Date"));
			jLabel_OrderDate.setHorizontalAlignment(SwingConstants.TRAILING);

			jCheckBoxDueDateFrom = new JCheckBox4j();
			jCheckBoxDueDateFrom.setBounds(124, 72, 21, 22);
			...
			jCheckBoxDueDateTo.setBounds(357, 72, 21, 22);
			...
			dueDateTo.setBounds(382, 72, 120, 22);
			...
			jComboBoxStatus.setBounds(148, 40, 120, 22);
			...
			jComboBoxSortBy.setBounds(622, 104, 172, 22);
			...
			jLabel_Recipe.setBounds(496, 40, 87, 22);
			jDesktopPane1.add(jLabel_Recipe);
			...
			jToggleButtonSequence.setBounds(795, 104, 22, 22);
			...
			jButtonMaterialLookuo.setBounds(481, 40, 21, 22);
			...
			jButtonCustomerLookup.setBounds(481, 8, 21, 22);
			...
			jButtonProcessOrderLookup.setBounds(247, 8, 21, 22);
			...
			jButtonLocationLookup.setBounds(962, 40, 21, 22);
			...
			jLabel_Limit.setBounds(790, 104, 100, 22);
			...
			jCheckBoxLimit.setBounds(897, 104, 21, 22);
			...
			jSpinnerLimit.setBounds(921, 104, 63, 22);
			jSpinnerLimit.setValue(1000);
			jSpinnerLimit.getEditor().setSize(45, 21);

			jStatusText = new JLabel4j_status();
			jStatusText.setBounds(5, 551, 985, 21);
			jDesktopPane1.add(jStatusText);

			jButtonExcel = new JButton4j(Common.icon_XLS_16x16);
			jButtonExcel.setBounds(771, 136, 109, 32);
			...
			jLabel_Quantity.setBounds(522, 72, 94, 22);
			jLabel_Quantity.setHorizontalAlignment(SwingConstants.TRAILING);
			jLabel_Quantity.setText(lang.get("lbl_Process_Order_Required_Quantity"));
			jDesktopPane1.add(jLabel_Quantity);

			jCheckBoxQuantity = new JCheckBox4j();
			jCheckBoxQuantity.setBounds(622, 72, 21, 22);
			...
			jLabel_OrderUOM = new JLabel4j_std();
			jLabel_OrderUOM.setBounds(753, 72, 98, 22);
			jLabel_OrderUOM.setHorizontalAlignment(SwingConstants.TRAILING);
			jLabel_OrderUOM.setText(lang.get("lbl_Process_Order_Required_UOM"));
			jDesktopPane1.add(jLabel_OrderUOM);

			ComboBoxModel<JDBUom> jComboBox2Model = new DefaultComboBoxModel<JDBUom>(uomList);
			jComboBoxUOM = new JComboBox4j<JDBUom>();
			jComboBoxUOM.setBounds(857, 72, 127, 22);
			...
			jButtonClear.setBounds(111, 136, 109, 32);
			...
			btnLookupCustomer.setBounds(481, 104, 22, 22);
			jDesktopPane1.add(btnLookupCustomer);

			JLabel4j_std jLabel_Resource = new JLabel4j_std();
			...
			btnLookupResource.setBounds(246, 104, 22, 22);
			...
			jLabelRecipeVersion.setBounds(706, 41, 21, 21);
