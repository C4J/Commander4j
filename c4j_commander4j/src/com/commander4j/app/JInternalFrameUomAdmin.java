 ...
 * @see com.commander4j.app.JInternalFrameUomProperties
 *      JInternalFrameUomProperties
 *
 */
public class JInternalFrameUomAdmin extends javax.swing.JInternalFrame
{
	...
	private void initGUI()
	{
		try
		{
			...
			jScrollPane1.setBounds(0, 0, 303, 518);
			...
			jButtonAdd.setBounds(304, 0, 125, 32);
			...
			jButtonDelete.setBounds(304, 31, 125, 32);
			...
			jButtonEdit.setBounds(304, 62, 125, 32);
			...
			jButtonRename.setBounds(304, 93, 125, 32);
			...
			jButtonPrint.setBounds(304, 124, 125, 32);
			...
			jButtonClose.setBounds(304, 248, 125, 32);
			...
			jButtonExcel.setBounds(304, 155, 125, 32);
