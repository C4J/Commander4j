...
/**
 * The JInternalFrameWTScaleProperties class allows the user to edit a record in
 * the APP_WEIGHT_SCALE table.
 *
 * <p>
...
public class JInternalFrameWTScaleProperties extends JInternalFrame
{
	...
	private JLabel4j_std jLabel_SerialNo;
	private JTextField4j jTextFieldDescription;
	private JTextField4j jTextFieldScale;
	private JTextField4j jTextFieldSerialNo;
	...
	public void setScaleID(String scaleid)
	{
		...
		jTextFieldSerialNo.setText(scale.getSerialNo());
	...
	private void initGUI()
	{
		try
		{
			...
			jLabel_Scale.setBounds(0, 8, 149, 22);
			...
			jTextFieldScale.setBounds(155, 8, 237, 22);
			...
			jLabel_Connection.setBounds(0, 168, 149, 22);
			...
			comboBox_Connection.setModel(new DefaultComboBoxModel<String>(new String[]
			{ "Serial", "Ethernet", "USB" }));
			...
			comboBox_Connection.setBounds(155, 168, 109, 22);
			...
			jButtonSave.setBounds(42, 426, 110, 32);
			...
			jButtonHelp.setBounds(154, 426, 110, 32);

			jButtonClose = new JButton4j(Common.icon_close_16x16);
			jDesktopPane1.add(jButtonClose);
			jButtonClose.setText(lang.get("btn_Close"));
			jButtonClose.setMnemonic(lang.getMnemonicChar());
			jButtonClose.setBounds(266, 426, 110, 32);
			...
			jLabel_SerialNo = new JLabel4j_std();
			jDesktopPane1.add(jLabel_SerialNo);
			...
			jLabel_SerialNo.setBounds(0, 72, 149, 22);
			...
			jTextFieldSerialNo = new JTextField4j(JDBWTScale.field_Serial);
			...
			jTextFieldSerialNo.setBounds(155, 72, 72, 22);
			...
			label4j_Make.setBounds(0, 104, 149, 22);
			...
			label4j_Model.setBounds(0, 136, 149, 22);
			...
			comboBox_Model.setModel(new DefaultComboBoxModel<String>(new String[]
			{ "N/A", "ICS465", "MONOBLOC", "ZK830", "VIPER" }));

			comboBox_Model.setBounds(155, 136, 237, 22);
			...
			comboBox_Make.setBounds(155, 104, 237, 22);
			...
			comboBox_Baud.setBounds(155, 200, 81, 22);
			...
			comboBox_DataBits.setBounds(155, 232, 49, 22);
			...
			comboBox_StopBits.setBounds(155, 264, 49, 22);
			...
			comboBox_FlowControl.setBounds(155, 328, 109, 22);
			...
			label4j_Baud.setBounds(0, 200, 149, 22);
			...
			label4j_DataBits.setBounds(0, 232, 149, 22);
			...
			label4j_StopBits.setBounds(0, 264, 149, 22);
			...
			label4j_FlowControl.setBounds(0, 328, 149, 22);
			...
			label4j_Parity.setBounds(0, 296, 149, 22);
			...
			comboBox_Parity.setModel(new DefaultComboBoxModel<String>(new String[]
			{ "None", "Odd", "Even", "Mark", "Space" }));
			comboBox_Parity.setPreferredSize(new Dimension(40, 20));
			comboBox_Parity.setFocusCycleRoot(true);
			comboBox_Parity.setBounds(155, 296, 81, 22);
			...
			label4j_EndOfLine.setBounds(0, 360, 149, 22);
			...
			label4j_CommandPrefix.setBounds(0, 392, 149, 22);
			...
			comboBox_EndOfLine.setModel(new DefaultComboBoxModel<String>(new String[]
			{ "<NONE>", "<CR>", "<LF>", "<CR><LF>", "<CR><LF><EOT>" }));
			comboBox_EndOfLine.setPreferredSize(new Dimension(40, 20));
			comboBox_EndOfLine.setFocusCycleRoot(true);
			comboBox_EndOfLine.setBounds(155, 360, 134, 22);
			...
			comboBox_CommandPrefix.setModel(new DefaultComboBoxModel<String>(new String[]
			{ "<NONE>", "<CR>", "<LF>", "<CR><LF>", "<CR><LF><EOT>" }));
			comboBox_CommandPrefix.setPreferredSize(new Dimension(40, 20));
			comboBox_CommandPrefix.setFocusCycleRoot(true);
			comboBox_CommandPrefix.setBounds(155, 392, 134, 22);
	...
	private void save()
	{
		...
		scale.setSerialNo(jTextFieldSerialNo.getText());
