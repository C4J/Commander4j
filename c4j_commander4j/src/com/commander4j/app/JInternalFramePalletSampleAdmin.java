...
public class JInternalFramePalletSampleAdmin extends JInternalFrame
{
	...
	private JLabel4j_std jLabel_Defect_Type;
	private JLabel4j_std jLabel_Batch;
	private JLabel4j_std jLabel_Defect_ID;
	private JLabel4j_std jLabel_Incident;
	private JLabel4j_std jLabel_Limit;
	private JLabel4j_std jLabel_Location;
	private JLabel4j_std jLabel_Material;
	private JLabel4j_std jLabel_Operative;
	private JLabel4j_std jLabel_Pallet_DOM;
	private JLabel4j_std jLabel_Pallet_Status;
	private JLabel4j_std jLabel_ProcessOrder;
	private JLabel4j_std jLabel_Reason;
	...
	private void initGUI()
	{
		try
		{
			...
			this.setClosable(true);
			{
				...
				jDesktopPane1.setBounds(0, 0, 1003, 621);
				...
				jDesktopPane1.setPreferredSize(new java.awt.Dimension(917, 504));
				{
					...
					jScrollPane1.setBounds(0, 280, 995, 310);
					{
...

						{
...

							{
...

								{
									...
									jStatusText.setBounds(5, 595, 985, 21);
				...
				jButtonSearch1.setBounds(3, 245, 140, 32);
				...
				jButtonQuantityChanges.setBounds(78, 200, 176, 32);
				...
				jLabel_Location.setBounds(0, 40, 108, 22);
				...
				jButtonHelp.setBounds(571, 245, 140, 32);
				jButtonHelp.setMnemonic(lang.getMnemonicChar());

				jButtonClose = new JButton4j(Common.icon_close_16x16);
				jDesktopPane1.add(jButtonClose);
				jButtonClose.setText(lang.get("btn_Close"));
				jButtonClose.setBounds(855, 245, 140, 32);
				...
				jButtonPrint.setBounds(287, 245, 140, 32);
				...
				jButtonPrint.setBounds(429, 245, 140, 32);
				...
				jLabel_Limit.setBounds(695, 200, 121, 22);
				...
				jComboBoxSortBy.setBounds(373, 200, 300, 22);
				...
				jComboBoxPalletStatus.setBounds(346, 136, 176, 22);
				...
				jComboBoxMonth.setBounds(683, 168, 92, 22);

				jLabel_Pallet_Status = new JLabel4j_std();
				jDesktopPane1.add(jLabel_Pallet_Status);
				jLabel_Pallet_Status.setText(lang.get("lbl_Pallet_Status"));
				jLabel_Pallet_Status.setHorizontalAlignment(SwingConstants.TRAILING);
				jLabel_Pallet_Status.setBounds(236, 136, 102, 22);

				jLabel_Operative = new JLabel4j_std();
				jLabel_Operative.setText(lang.get("lbl_Operator_ID"));
				jLabel_Operative.setHorizontalAlignment(SwingConstants.TRAILING);
				jLabel_Operative.setBounds(531, 136, 80, 22);
				jDesktopPane1.add(jLabel_Operative);

				jTextFieldOperative = new JTextField4j();
				jTextFieldOperative.setEditable(false);
				jTextFieldOperative.setBounds(622, 136, 73, 22);
				...
				jButtonLookup_Operative.setBounds(695, 136, 21, 22);
				...
				jToggleButtonSequence.setBounds(674, 200, 21, 22);
				...
				jLabel_ProcessOrder.setBounds(695, 104, 121, 22);

				jTextFieldProcessOrder = new JTextField4j(JDBProcessOrder.field_process_order);
				jDesktopPane1.add(jTextFieldProcessOrder);
				jTextFieldProcessOrder.setBounds(824, 104, 130, 22);
				...
				jLabel_SortBy.setBounds(236, 200, 130, 22);

				// Limit
				SpinnerNumberModel jSpinnerIntModelLimit = new SpinnerNumberModel();
				jSpinnerIntModelLimit.setMinimum(1);
				jSpinnerIntModelLimit.setMaximum(100000);
				jSpinnerIntModelLimit.setStepSize(1);
				jSpinnerLimit = new JSpinner4j();
				jSpinnerLimit.setModel(jSpinnerIntModelLimit);
				JSpinner4j.NumberEditor neLimit = new JSpinner4j.NumberEditor(jSpinnerLimit);
				jSpinnerLimit.setEditor(neLimit);
				jSpinnerLimit.setBounds(844, 200, 73, 22);
				jSpinnerLimit.setValue(1000);
				jSpinnerLimit.getEditor().setSize(45, 21);
				jDesktopPane1.add(jSpinnerLimit);

				// Year
				SpinnerNumberModel jSpinnerIntModelYear = new SpinnerNumberModel();
				jSpinnerIntModelYear.setMinimum(1980);
				jSpinnerIntModelYear.setMaximum(2500);
				jSpinnerIntModelYear.setStepSize(1);
				jSpinnerYear = new JSpinner4j();
				jSpinnerYear.setEnabled(false);
				jSpinnerYear.setModel(jSpinnerIntModelYear);
				JSpinner4j.NumberEditor neYear = new JSpinner4j.NumberEditor(jSpinnerYear, "#");
				jSpinnerYear.setEditor(neYear);
				jSpinnerYear.setBounds(329, 168, 63, 22);
				...
				// Week No
				SpinnerNumberModel jSpinnerIntModelWeekNo = new SpinnerNumberModel();
				jSpinnerIntModelWeekNo.setMinimum(1);
				jSpinnerIntModelWeekNo.setMaximum(53);
				jSpinnerIntModelWeekNo.setStepSize(1);
				jSpinnerWeekNumber = new JSpinner4j();
				jSpinnerWeekNumber.setEnabled(false);
				jSpinnerWeekNumber.setModel(jSpinnerIntModelWeekNo);
				JSpinner4j.NumberEditor neWeekNo = new JSpinner4j.NumberEditor(jSpinnerWeekNumber, "#");
				jSpinnerWeekNumber.setEditor(neWeekNo);
				jSpinnerWeekNumber.setBounds(541, 168, 45, 22);
				...
				jCheckBoxLimit.setBounds(823, 200, 21, 22);
				...
				jCheckBoxYear.setBounds(300, 168, 21, 22);
				...
				jCheckBoxWeekNumber.setBounds(512, 168, 21, 22);
				jCheckBoxYear.addActionListener(new ActionListener()
				{
					public void actionPerformed(ActionEvent evt)
					{
				...
				jButtonLookupProcessOrder.setBounds(954, 104, 21, 22);
				...
				jButtonLookupMHN.setBounds(206, 136, 21, 22);
				...
				jButtonLookupBatch.setBounds(954, 72, 21, 22);
				...
				jButtonLookupMaterial.setBounds(954, 40, 21, 22);
				...
				jButtonLookupLocationID.setBounds(206, 40, 21, 22);
				...
				jCheckBoxProductionDate.setBounds(165, 8, 21, 22);
				...
				jCheckBoxSampleDate.setBounds(625, 8, 21, 22);
				...
				jLabel_Sample_Date.setBounds(486, 8, 128, 22);
				...
				jLabel_Pallet_DOM.setBounds(0, 8, 152, 22);
				jDesktopPane1.add(jLabel_Pallet_DOM);

				jLabel_Reason = new JLabel4j_std();
				jLabel_Reason.setHorizontalAlignment(SwingConstants.TRAILING);
				jLabel_Reason.setText(lang.get("lbl_Reason"));
				jLabel_Reason.setBounds(236, 40, 102, 22);
				jDesktopPane1.add(jLabel_Reason);

				jLabel_Defect_ID = new JLabel4j_std();
				jLabel_Defect_ID.setHorizontalAlignment(SwingConstants.TRAILING);
				jLabel_Defect_ID.setText(lang.get("lbl_Defect_ID"));
				jLabel_Defect_ID.setBounds(236, 104, 102, 22);
				jDesktopPane1.add(jLabel_Defect_ID);

				jLabel_Defect_Type = new JLabel4j_std();
				jLabel_Defect_Type.setHorizontalAlignment(SwingConstants.TRAILING);
				jLabel_Defect_Type.setText(lang.get("lbl_Defect_Type"));
				jLabel_Defect_Type.setBounds(236, 72, 102, 22);
				jDesktopPane1.add(jLabel_Defect_Type);
				...
				jComboBoxSampleReason.setBounds(346, 40, 300, 22);
				...
				jComboBoxDefectID.setBounds(346, 104, 300, 22);
				...
				ComboBoxModel<JDBSampleDefectTypes> jComboBox4Model = new DefaultComboBoxModel<JDBSampleDefectTypes>(defectTypeList);
				...
				exportXlsButton.setBounds(713, 245, 140, 32);
				jDesktopPane1.add(exportXlsButton);

				jTextFieldIncidentRef.setBounds(114, 168, 92, 22);
				jDesktopPane1.add(jTextFieldIncidentRef);

				jLabel_Incident = new JLabel4j_std();
				jLabel_Incident.setHorizontalAlignment(SwingConstants.TRAILING);
				jLabel_Incident.setText(lang.get("lbl_Incident_Ref"));
				jLabel_Incident.setBounds(0, 168, 108, 22);
				jDesktopPane1.add(jLabel_Incident);

				JLabel4j_std jLabel_Leaking = new JLabel4j_std();
				jLabel_Leaking.setText(lang.get("lbl_Leaking"));
				jLabel_Leaking.setHorizontalAlignment(SwingConstants.TRAILING);
				jLabel_Leaking.setBounds(817, 168, 130, 22);
				jDesktopPane1.add(jLabel_Leaking);
				...
				jLabel_WeekNumber.setBounds(399, 168, 101, 22);
				...
				jButtonClear.setBounds(145, 245, 140, 32);
				jDesktopPane1.add(jButtonClear);

				JLabel4j_std JLabel_Sample_Location_Main = new JLabel4j_std();
				JLabel_Sample_Location_Main.setText(lang.get("lbl_Sample_Location"));
				JLabel_Sample_Location_Main.setHorizontalAlignment(SwingConstants.TRAILING);
				JLabel_Sample_Location_Main.setBounds(0, 72, 108, 22);
				jDesktopPane1.add(JLabel_Sample_Location_Main);
					...
					jLabel_Sample_Point.setBounds(0, 104, 108, 22);


				jTextFieldSample_Location_Plant.setBounds(114, 72, 92, 22);
				...
				button4j_sublocation.setBounds(206, 72, 21, 22);
				jDesktopPane1.add(button4j_sublocation);

				jTextFieldSample_LocationFiller.setBounds(114, 104, 92, 22);
				...
				button4j_samplepoint.setBounds(206, 104, 21, 22);
				...
				calendarButtonproductionDateFrom.setBounds(309, 9, 21, 21);
				...
				calendarButtontProductionDateTo.setBounds(469, 9, 21, 21);
				...
				calendarButtonsampleDateFrom.setBounds(768, 9, 21, 21);
				...
				calendarButtonsampleDateTo.setBounds(944, 9, 21, 21);
