...
public class JInternalFrameSampleDefectTypeAdmin extends JInternalFrame
{
	...
	private void initGUI()
	{
		try
		{
			...
			jButtonAdd.setBounds(479, 0, 126, 32);
			...
			jButtonDelete.setBounds(479, 31, 126, 32);
			...
			jButtonEdit.setBounds(479, 62, 126, 32);
			...
			jButtonRename.setBounds(479, 93, 126, 32);
			...
			jButtonPrint.setBounds(479, 124, 126, 32);
			...
			jButtonClose.setBounds(479, 218, 126, 32);
			...
			panel.setBounds(479, 258, 125, 68);
