		...
		try
		{
			...
			this.setTitle("Material Group");
			{
				...
				jDesktopPane1.setLayout(null);
				{
					...
					jLabel_ProductGroup.setBounds(29, 12, 137, 22);
				}
				{
				...
				jLabel_Description.setBounds(29, 46, 137, 22);
				...
				jTextField_Description.setBounds(176, 46, 204, 22);
				...
				jLabel_NominalWeight.setBounds(29, 80, 137, 22);
				...
				jTextField_NominalWeight_UOM.setBounds(296, 80, 50, 22);
				...
				jLabel_TareWeight.setBounds(29, 114, 137, 22);
				...
				jTextField_TareWeight_UOM.setBounds(296, 114, 50, 22);
				...
				label4j_std_lowerLimit.setBounds(29, 150, 137, 22);
				...
				label4j_std_upperLimit.setBounds(29, 185, 137, 22);
				...
				label4j_std_samplesRequired.setBounds(29, 218, 137, 22);
				...
				
				{
					...
					jSpinnerSamplesRequired.setBounds(176, 218, 63, 22);
