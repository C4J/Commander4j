...
public class JInternalFrameWTWorkstationProperties extends JInternalFrame
{
	...
	private JLabel4j_std jLabel_Workstation;
	...
	public void setWorkstationID(String wstation)
	{
		...
		comboBox_Ports.setBounds(155, 168, 387, 22);
	...
	private void initGUI()
	{
		try
		{
			...
			jLabel_Workstation = new JLabel4j_std();
			jDesktopPane1.add(jLabel_Workstation);
			jLabel_Workstation.setText(lang.get("lbl_Workstation"));
			jLabel_Workstation.setHorizontalAlignment(SwingConstants.RIGHT);
			jLabel_Workstation.setHorizontalTextPosition(SwingConstants.RIGHT);
			jLabel_Workstation.setBounds(0, 8, 149, 22);
			...
			jTextFieldWorkstation.setBounds(155, 8, 237, 22);
			...
			jButtonSave.setBounds(115, 234, 110, 32);
			...
			jButtonHelp.setBounds(227, 234, 110, 32);

			jButtonClose = new JButton4j(Common.icon_close_16x16);
			jDesktopPane1.add(jButtonClose);
			jButtonClose.setText(lang.get("btn_Close"));
			jButtonClose.setMnemonic(lang.getMnemonicChar());
			jButtonClose.setBounds(339, 234, 110, 32);
			...
			label4j_Scale_ID.setBounds(0, 136, 149, 22);
			...
			label4j_Scale_Port.setBounds(0, 168, 149, 22);
			...
			comboBox_Scales.setBounds(155, 136, 387, 22);
			...
			comboBox4j_SamplePoint.setBounds(155, 104, 387, 22);
			...
			label4j_SamplePoint.setBounds(0, 104, 149, 22);
			...
			label4j_Override.setBounds(0, 200, 149, 22);
			...
			label4j_SampleSize.setBounds(184, 200, 78, 22);
			jDesktopPane1.add(label4j_SampleSize);

			checkOverride.setBounds(155, 200, 21, 22);
			...
			jSpinnerLimit.setBounds(269, 200, 68, 22);
