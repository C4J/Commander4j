...
public class JInternalFramePrinterAdmin extends javax.swing.JInternalFrame
{
	...
	private void initGUI()
	{
		try
		{
			...
			jScrollPane1.setBounds(0, 40, 1010, 349);
			...
			rdbtnAll.setBounds(120, 8, 54, 22);
			...
			rdbtnPack.setBounds(193, 8, 62, 22);
			...
			;
			rdbtnPallet.setBounds(266, 8, 67, 22);
			...
			;
			rdbtnGeneral.setBounds(339, 8, 67, 22);
			getContentPane().add(rdbtnGeneral);

			jStatusText.setBounds(5, 435, 1003, 21);
			...
			comboBoxPrinterTypes.setBounds(567, 8, 155, 22);
