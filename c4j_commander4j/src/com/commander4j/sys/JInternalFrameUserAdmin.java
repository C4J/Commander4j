...
public class JInternalFrameUserAdmin extends javax.swing.JInternalFrame
{
	...
	private void copyrecord()
	{
		...
		if (jListUsers.isSelectionEmpty() == false)
		{
			...
			// String oldUserID = ((JDBListData)
			// jListUsers.getSelectedValue()).toString();
			JDBUser u = new JDBUser(Common.selectedHostID, Common.sessionID);
	...
	private void rename()
	{
		if (jListUsers.isSelectionEmpty() == false)
		{
			...
			// String luser_id_from = ((JDBListData)
			// jListUsers.getSelectedValue()).toString();
	...
	private void populateList(String defaultitem)
	{
		...
		for (int j = 0; j < tempUserList.size(); j++)
		{
			...
			/*
			 * if (tempUserList.get(j).toString().equals(defaultitem)) { sel =
			 * j; }
			 */
		}
	...
	private void initGUI()
	{
		try
		{
			...
			jButtonAdd.setBounds(426, 0, 125, 32);
			...
			jButtonDelete.setBounds(426, 31, 125, 32);
			...
			jButtonUpdate.setBounds(426, 62, 125, 32);
			...
			jButtonClose.setBounds(426, 341, 125, 32);
			...
			jButtonPermissions.setBounds(426, 93, 125, 32);
			...
			jButtonPrint.setBounds(426, 186, 125, 32);
			...
			jButtonExport.setBounds(426, 217, 125, 32);
			...
			jButtonRename.setBounds(426, 124, 125, 32);
			...
			jButtonExcel.setBounds(426, 279, 125, 32);
			...
			jButtonCopy.setBounds(426, 155, 125, 32);
