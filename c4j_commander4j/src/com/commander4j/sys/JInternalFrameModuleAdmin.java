...
public class JInternalFrameModuleAdmin extends javax.swing.JInternalFrame
{
	...
	private void rename()
	{
		if (jListModules.isSelectionEmpty() == false)
		{
			...
			lmodule_id_to = JOptionPane.showInputDialog(Common.mainForm, lang.get("dlg_Rename"), lmodule_id_from);
	...
	private void initGUI()
	{
		try
		{
			...
			jButtonAdd.setBounds(366, 0, 167, 32);
			...
			jButtonDelete.setBounds(366, 31, 167, 32);
			...
			jButtonEdit.setBounds(366, 62, 167, 32);
			...
			jButtonPrint.setBounds(366, 186, 167, 32);
			...
			jButtonClose.setBounds(366, 370, 167, 32);
			...
			jButtonRename.setBounds(366, 93, 167, 32);
			...
			jButtonHelp.setBounds(366, 309, 167, 32);
			jDesktopPane1.add(jButtonHelp);
			jButtonHelp.setText(lang.get("btn_Help"));
			jButtonHelp.setMnemonic(lang.getMnemonicChar());

			jButtonRefresh = new JButton4j(Common.icon_refresh_16x16);
			jButtonRefresh.setBounds(366, 340, 167, 32);
			...
			jRadioButtonAll.setBounds(374, 414, 159, 22);
			...
			jRadioButtonForms.setBounds(374, 442, 159, 22);
			...
			jRadioButtonFunctions.setBounds(374, 470, 159, 22);
			...
			jRadioButtonMenus.setBounds(374, 498, 159, 22);
			...
			jRadioButtonReports.setBounds(374, 526, 159, 22);
			...
			jRadioButtonUserReports.setBounds(374, 582, 159, 22);
			...
			jRadioButtonExec.setBounds(374, 554, 159, 22);
			...
			jButtonExcel.setBounds(366, 278, 167, 32);
			...
			jButtonGroups.setBounds(366, 155, 167, 32);
			...
			jButtonAlternative.setEnabled(false);
			jButtonAlternative.setBounds(366, 216, 167, 32);
			...
			jButtonTestHelp.setEnabled(false);
			jButtonTestHelp.setBounds(366, 247, 167, 32);
			...
			jButtonCopy.setBounds(366, 124, 167, 32);
