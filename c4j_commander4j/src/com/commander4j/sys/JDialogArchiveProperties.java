 ...
 *
 * @see com.commander4j.sys.JInternalFrameArchiveAdmin
 *      JInternalFrameArchiveAdmin
...
public class JDialogArchiveProperties extends JDialog
{
	...
	private void initGUI()
	{
		try
		{
			...
			jLabelSQLStatement.setBounds(5, 72, 185, 22);
			...
			jLabelArchiveID.setBounds(5, 8, 185, 22);
			...
			jLabelDescription.setBounds(5, 40, 185, 22);

			jButtonUpdate = new JButton4j(Common.icon_update_16x16);
			jDesktopPane1.add(jButtonUpdate);
			jButtonUpdate.setText(lang.get("btn_Save"));
			jButtonUpdate.setBounds(90, 232, 126, 32);
			...
			jButtonClose.setBounds(490, 232, 126, 32);
			...
			jTextFieldArchiveID.setBounds(202, 8, 151, 22);
			...
			jTextFieldDescription.setBounds(202, 40, 260, 22);
			...
			jTextFieldSQLTable.setBounds(202, 72, 260, 22);
			...
			jButtonHelp.setBounds(355, 232, 126, 32);
			...
			labelEnabled.setBounds(468, 8, 151, 22);
			jDesktopPane1.add(labelEnabled);

			chckbxEnabled.setBounds(624, 8, 28, 22);
			...
			chckbxBackgroundTask.setBounds(624, 40, 28, 22);
			...
			label4jRetention.setBounds(5, 136, 185, 21);
			...
			label4j_Sequence.setBounds(5, 168, 185, 21);
			...
			label4j_MaxDelete.setBounds(5, 200, 185, 21);
			...
			jSpinnerRetention.setBounds(202, 136, 79, 21);
			...
			jSpinnerSequence.setBounds(202, 168, 79, 21);
			...
			jSpinnerMaxDelete.setBounds(202, 200, 79, 21);
			...
			jTextFieldSQLCriteria.setBounds(202, 104, 450, 21);
			...
			label4j_Criteria.setBounds(5, 104, 185, 21);
			...
			jButtonRun.setBounds(222, 232, 126, 32);
			...
			label4jBackgroundTask.setBounds(468, 40, 151, 22);
			...
			label4jArchiveBefore.setBounds(293, 136, 185, 21);
