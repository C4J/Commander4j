...
/**
 * The JInternalFrameGroupUsers class is a form which displays a list of users
 * who are assigned to the selected Group.
 * <p>
...
public class JInternalFrameGroupUsers extends javax.swing.JInternalFrame
{
	...
	private void initGUI()
	{
		try
		{
			...
			jScrollPane1.setBounds(0, 0, 190, 503);
			...
			jButtonClose.setBounds(191, 156, 125, 32);
			...
			jButtonPermissions.setBounds(191, 0, 125, 32);
			...
			jButtonPrint.setBounds(191, 32, 125, 32);
			...
			jButtonExcel.setBounds(191, 94, 125, 32);
