...
public class JInternalFrameAuditPermissionsAdmin extends JInternalFrame
{
	...
	public JInternalFrameAuditPermissionsAdmin()
	{
		...
		calendarButtonEventFrom.setBounds(266, 72, 22, 22);
		...
		calendarButtonEventTo.setBounds(452, 72, 22, 22);
	...
	private void initGUI()
	{
		try
		{
			...
			jScrollPane1.setBounds(0, 150, 991, 382);
			...
			jButtonSearch.setBounds(217, 104, 109, 32);
			...
			jButtonPrint.setBounds(435, 104, 109, 32);
			...
			jButtonClose.setBounds(654, 104, 109, 32);
			...
			lbl_Data.setBounds(676, 40, 125, 22);
			...
			lbl_EventAction.setBounds(318, 40, 140, 22);
			...
			jTextFieldWorkstation.setBounds(124, 40, 175, 22);
			jDesktopPane1.add(jTextFieldWorkstation);

			lbl_SortBy = new JLabel4j_std();
			lbl_SortBy.setBounds(480, 72, 135, 22);
			...
			eventsFrom.setBounds(146, 72, 120, 22);
			...
			lbl_EventDate.setBounds(0, 72, 110, 22);
			...
			jCheckBoxEventsFrom.setBounds(120, 72, 22, 22);
			...
			jCheckBoxEventsTo.setBounds(303, 72, 22, 22);
			...
			eventsTo.setBounds(330, 72, 120, 22);
			...
			jComboBoxEventAction.setBounds(470, 40, 194, 22);
			...
			{ "SYS_AUDIT_LOG_ID", "EVENT_TIME", "USER_ID", "EVENT_TYPE", "EVENT_ACTION", "TARGET", "DATA", "WORKSTATION" });
			jComboBoxSortBy = new JComboBox4j<String>();
			jComboBoxSortBy.setBounds(625, 72, 168, 22);
			jDesktopPane1.add(jComboBoxSortBy);
			jComboBoxSortBy.setModel(jComboBoxSortByModel);
			jComboBoxSortBy.getModel().setSelectedItem("SYS_AUDIT_LOG_ID");

			lbl_Workstation = new JLabel4j_std();
			lbl_Workstation.setBounds(0, 40, 110, 22);
			...
			jToggleButtonSequence.setBounds(791, 72, 22, 22);
			...
			jButtonUserIDLookup.setBounds(274, 8, 21, 22);
			...
			lbl_Limit.setBounds(791, 72, 100, 22);
			...
			jCheckBoxLimit.setBounds(896, 72, 22, 22);
			...
			jSpinnerLimit.setBounds(917, 72, 63, 22);
			jSpinnerLimit.setValue(1000);
			jSpinnerLimit.getEditor().setSize(45, 21);

			jStatusBar = new JLabel4j_status();
			jStatusBar.setBounds(5, 540, 981, 21);
			jDesktopPane1.add(jStatusBar);

			jButtonExcel = new JButton4j(Common.icon_XLS_16x16);
			jButtonExcel.setBounds(546, 104, 109, 32);
			...
			lbl_EventType.setBounds(318, 8, 140, 22);
			...
			jComboBoxEventType.setBounds(470, 8, 194, 22);
			...
			jButtonClear.setBounds(327, 104, 109, 32);
