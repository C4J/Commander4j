...
public class JInternalFrameUserPermissions extends javax.swing.JInternalFrame
{
	...
	private void populateAssignedList()
	{
		...
		jListAssigned.setMode(JList4j.Assigned);
	...
	private void populateUnAssignedList()
	{
		...
		jListUnassigned.setMode(JList4j.UnAssigned);
	...
	private void initGUI()
	{
		try
		{
			...
			jButtonUnAssign.setBounds(212, 218, 26, 23);
			...
			jScrollPaneUnassigned.setBounds(250, 23, 200, 423);
			jScrollPaneUnassigned.setHorizontalScrollBarPolicy(JScrollPane4j.HORIZONTAL_SCROLLBAR_NEVER);
			jScrollPaneUnassigned.setBorder(BorderFactory.createEtchedBorder(BevelBorder.LOWERED));

			ListModel<String> jListUnassignedModel = new DefaultComboBoxModel<String>(new String[]
			{ "Item One", "Item Two" });
			...
			jScrollPaneAssigned.setBounds(0, 23, 200, 423);
			jScrollPaneAssigned.setFocusable(false);
			jScrollPaneAssigned.setHorizontalScrollBarPolicy(JScrollPane4j.HORIZONTAL_SCROLLBAR_NEVER);
			jScrollPaneAssigned.setBorder(BorderFactory.createEtchedBorder(BevelBorder.LOWERED));

			ListModel<String> jListAssignedModel = new DefaultComboBoxModel<String>(new String[]
			{ "Item One", "Item Two" });
			...
			jListAssigned.setForeground(Common.color_list_foreground);
			...
			jButtonUndo.setBounds(72, 458, 105, 32);
			...
			jButtonSave.setBounds(180, 458, 105, 32);
			...
			jButtonClose.setBounds(287, 458, 105, 32);
