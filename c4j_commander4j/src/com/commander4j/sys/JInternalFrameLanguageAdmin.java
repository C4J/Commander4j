...
/**
 * The JInternalFrameLanguageAdmin class is a form which displays all the text
 * used within the application filtered by language. Add text is stored in a
 ...
 * @see com.commander4j.sys.JInternalFrameLanguageProperties
 *      JInternalFrameLanguageProperties
...
public class JInternalFrameLanguageAdmin extends javax.swing.JInternalFrame
{
	...
	private void initGUI()
	{
		try
		{
			...
			jButtonEdit.setBounds(246, 72, 120, 32);
			...
			jButtonClose.setBounds(856, 72, 120, 32);
			...
			jButtonAdd.setBounds(124, 72, 120, 32);
			...
			jButtonDelete.setBounds(368, 72, 120, 32);
			...
			jButtonPrint.setBounds(612, 72, 120, 32);
			...
			jButtonExcel.setBounds(490, 72, 120, 32);
			...
			button.setBounds(3, 72, 120, 32);
			jDesktopPane1.add(button);

			JLabel4j_status jStatusBar = new JLabel4j_status();

			jStatusBar.setBounds(5, 550, 972, 21);
			...
			label_2.setBounds(557, 8, 115, 22);
			...
			label_4.setBounds(557, 40, 115, 22);
			...
			comboBoxLanguageID.setBounds(141, 8, 72, 22);
	...
	private void addrecord()
	{
		...
		if (resourceKey.equals("") == false)
		{
			...
			languageID = JUtility.replaceNullStringwithBlank((String) JOptionPane.showInputDialog(Common.mainForm, lang.get("lbl_Language_ID"), "Select Language", JOptionPane.QUESTION_MESSAGE, null, Common.languages, "EN"));
