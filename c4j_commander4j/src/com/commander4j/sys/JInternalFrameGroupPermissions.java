...
/**
 * The JInternalFrameGroupPermissions class is a form which allows a user to
 * manage permissions by assigning modules to a group. Groups are then assigned
 * to a user. This class updates the table SYS_GROUP_PERMISSIONS
 * <p>
...
public class JInternalFrameGroupPermissions extends javax.swing.JInternalFrame
{
	...
	private void populateUnAssignedList()
	{
		...
		jListAssigned.setBackground(Common.color_list_background_unassigned);
