...
public class JDialogGroupProperties extends JDialog
{
	...
	private void initGUI()
	{
		try
		{
			...
			jTextFieldGroupId.setBounds(101, 8, 170, 22);
			...
			jLabelGroupID.setBounds(5, 8, 83, 22);
			...
			jLabelDescription.setBounds(5, 40, 86, 22);
			...
			jButtonUpdate.setBounds(50, 72, 110, 32);
			...
			jButtonClose.setBounds(272, 72, 110, 32);
			...
			jTextFieldDescription.setBounds(101, 40, 314, 22);
			...
			jButtonHelp.setBounds(161, 72, 110, 32);
