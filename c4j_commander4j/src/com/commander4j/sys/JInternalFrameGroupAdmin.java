...
/**
 * The JInternalFrameGroupAdmin class is a form which allows a user to manage
 * the groups held in the table SYS_GROUPS. This table is part of the
 * security/permissions configuration within the system. A group will contain a
 * list of modules which a user is allowed to access. A user is then allocated
 * one or more groups.
 * <p>
...
public class JInternalFrameGroupAdmin extends javax.swing.JInternalFrame
{
	...
	private void initGUI()
	{
		try
		{
			...
			jButtonAdd.setBounds(226, 0, 125, 32);
			...
			jButtonDelete.setBounds(226, 31, 125, 32);
			...
			jButtonEdit.setBounds(226, 62, 125, 32);
			...
			jButtonPermissions.setBounds(226, 93, 125, 32);
			...
			jButtonClose.setBounds(226, 310, 125, 32);
			...
			jButtonPrint.setBounds(226, 186, 125, 32);
			...
			jButtonRename.setBounds(226, 124, 125, 32);
			...
			jButtonExcel.setBounds(226, 248, 125, 32);
			...
			jButtonUsers.setBounds(226, 155, 125, 32);
