...
/**
 * The JInternalFrameModuleGroups class displays a list of all the groups which
 * contain the selected module.
 *
 * <p>
...
public class JInternalFrameModuleGroups extends javax.swing.JInternalFrame
{
	...
	private void initGUI()
	{
		try
		{
			...
			jButtonClose.setBounds(191, 160, 125, 32);
			...
			jButtonExcel.setBounds(191, 96, 125, 32);
