...
public class JDialogControlProperties extends JDialog
{
	...
	private void initGUI()
	{
		try
		{
			...
			jDesktopPane1.setBounds(0, 0, 736, 181);
			...
			jLabelSystemKey.setBounds(9, 72, 87, 22);
			...
			jLabelKeyValue.setBounds(5, 8, 93, 22);
			...
			jLabelDescription.setBounds(10, 40, 88, 22);
			...
			jButtonUpdate.setBounds(215, 104, 110, 32);
			...
			jButtonClose.setBounds(436, 104, 110, 32);
			...
			jTextFieldSystemKey.setBounds(106, 8, 252, 22);
			...
			jTextFieldKeyValue.setBounds(106, 40, 604, 22);
			...
			jTextFieldDescription.setBounds(106, 72, 604, 22);
			...
			jButtonHelp.setBounds(330, 104, 100, 32);
