 ...
 *
 * @see com.commander4j.interfaces.JInternalFrameInterfaceProperties
 *      JInternalFrameInterfaceProperties
...
public class JInternalFrameInterfaceAdmin extends JInternalFrame
{
	...
	private void initGUI()
	{
		try
		{
			...
			jScrollPane1.setBounds(0, 180, 955, 327);
			...
			jButtonEdit.setBounds(482, 136, 118, 32);
			...
			jButtonHelp.setBounds(722, 136, 118, 32);
			jDesktopPane1.add(jButtonHelp);
			jButtonHelp.setText(lang.get("btn_Help"));
			jButtonHelp.setMnemonic(java.awt.event.KeyEvent.VK_H);

			jButtonClose = new JButton4j(Common.icon_close_16x16);
			jButtonClose.setBounds(842, 136, 118, 32);
			...
			jComboBoxSortBy.setBounds(152, 104, 209, 22);
			jDesktopPane1.add(jComboBoxSortBy);
			jComboBoxSortBy.setModel(jComboBoxSortByModel);

			jLabel5 = new JLabel4j_std();
			jLabel5.setBounds(12, 40, 133, 22);
			...
			jComboBoxInterfaceDirection.setBounds(152, 40, 134, 22);
			...
			jToggleButtonSequence.setBounds(361, 104, 22, 22);
			...
			jButtonAdd.setBounds(242, 136, 118, 32);
			...
			jStatusBar.setBounds(5, 515, 946, 22);
			jDesktopPane1.add(jStatusBar);

			jButtonExcel = new JButton4j(Common.icon_XLS_16x16);
			jButtonExcel.setBounds(602, 136, 118, 32);
			...
			jButtonClear.setBounds(122, 136, 118, 32);
			...
			jButtonDelete.setBounds(362, 136, 118, 32);
