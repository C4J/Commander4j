...
public class Common
{
	...
	public static String[] wasteSortBy = new String[] {"TRANSACTION_REF","REPORT_TIME", "WASTE_MATERIAL_ID", "WASTE_LOCATION_ID", "PROCESS_ORDER","WASTE_REASON_ID", "WASTE_TRANSACTION_TYPE","QUANTITY","WEIGHT_KG","COST"};
