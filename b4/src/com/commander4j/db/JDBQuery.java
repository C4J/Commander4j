 ...
 * user searching for data on one of the data admin screens. It should be noted
 * that this class has been superseded by JDBQuery2
 *
 * @see com.commander4j.db.JDBQuery2 JDBQuery2
 */
