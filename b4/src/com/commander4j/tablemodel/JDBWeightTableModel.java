...
public class JDBWeightTableModel extends AbstractTableModel
{
	...
	public JDBWeightTableModel()
	{

	}

	public JDBWeightTableModel(ResultSet rs)
	{
		super();
	...
	public Object getValueAt(int row, int col) {
		...
		try
		{
			...
			case SampleDate_Col:
				...
				try
				{
					result = cache.get(row).getSampleDate().toString().substring(0, 16);
				}
				catch (Exception ex)
				{
					result = "";
