 ...
 */
public class JInternalFrameWTWeightCapture2 extends JInternalFrame
{
	...
	public JInternalFrameWTWeightCapture2()
	{
		super();
		setIconifiable(true);
	...
	private void createChart(CategoryDataset dataset)
	{
		...
		chart.setTitle(samplePointdb.getDescription()+" Mean Weights (" + String.valueOf(lGraphWindowHours) + " Hours)");
