...
public class JInternalFrameJourneyAdmin extends JInternalFrame {
		...
		if (ljourneyref != null) {
			if (ljourneyref.equals("") == false) {
				...
				if (jref.isValidJourneyRef(ljourneyref) == false) {
					...
					JOptionPane.showMessageDialog(Common.mainForm, "Journey Ref [" + ljourneyref + "] already exists",
							lang.get("err_Error"), JOptionPane.ERROR_MESSAGE, Common.icon_confirm);
				}
	...
	private void populateList() {
		...
		JDBJourneyRefTableModel journeyTable = new JDBJourneyRefTableModel(
				journeyref.getJourneyRefDataResultSet(listStatement));
	...
	private void deleteRecord() {
		...
		if (row >= 0) {
			lref = jTable1.getValueAt(row, 0).toString();
			int question = JOptionPane.showConfirmDialog(Common.mainForm,
					lang.get("dlg_Journey_Ref_Delete") + " " + lref + " ?", lang.get("dlg_Confirm"),
		...
		try {
			...
			this.setTitle("Journey References");
			{
				...
				jDesktopPane1.setPreferredSize(new java.awt.Dimension(483, 266));
				{
					...
					jScrollPane1.setBounds(0, 230, 639, 373);
					{
						...
						jTable1.addMouseListener(new MouseAdapter() {
							public void mouseClicked(MouseEvent evt) {
								if (evt.getClickCount() == 2) {
									if (Common.userList.getUser(Common.sessionID)
											.isModuleAllowed("FRM_ADMIN_JOURNEY_EDIT")) {
										editRecord();
									}
								}
							}
...

						{
...

							{
								...
								newItemMenuItem.setEnabled(Common.userList.getUser(Common.sessionID)
										.isModuleAllowed("FRM_ADMIN_JOURNEY_ADD"));
								newItemMenuItem.addActionListener(new ActionListener() {
									public void actionPerformed(final ActionEvent e) {
										addRecord();
									}
				...
				}
				{
					...
					jButtonSearch.setBounds(330, 11, 126, 32);
				...
				}
				{
					...
					jButtonEdit.setBounds(330, 101, 126, 32);
					jButtonEdit.setEnabled(
							Common.userList.getUser(Common.sessionID).isModuleAllowed("FRM_ADMIN_JOURNEY_EDIT"));
				...
				}
				{
					...
					jButtonHelp.setBounds(457, 71, 126, 32);
				}
				{
					...
					jButtonClose.setBounds(457, 101, 126, 32);
				...
				}
				{
					...
					jLabel10.setBounds(12, 188, 113, 21);
				}
				{
					ComboBoxModel<String> jComboBoxSortByModel = new DefaultComboBoxModel<String>(
							new String[] { "JOURNEY_REF", "LOCATION_ID_TO","DESPATCH_NO", "STATUS", "TIMESLOT","DATE_UPDATED" });
					jComboBoxSortBy = new JComboBox4j<String>();
					jDesktopPane1.add(jComboBoxSortBy);
					jComboBoxSortBy.setModel(jComboBoxSortByModel);
					jComboBoxSortBy.setBounds(132, 188, 141, 23);
				}
				{
				...
				{
					timeslotFrom.setBounds(153, 149, 125, 25);
					timeslotFrom.setEnabled(false);
					jDesktopPane1.add(timeslotFrom);
				}

				{
					timeslotTo.setBounds(377, 149, 125, 25);
					timeslotTo.setEnabled(false);
...

				{
					...
					jLabel5_1.setBounds(12, 153, 113, 21);
...

				{
					...
					jCheckBoxFrom.setBounds(132, 153, 21, 21);
...

				{
					...
					jCheckBoxTo.setBounds(356, 153, 21, 21);
					jDesktopPane1.add(jCheckBoxTo);
				}

				{
					jButtonAdd = new JButton4j(Common.icon_add);
					jButtonAdd.setEnabled(
							Common.userList.getUser(Common.sessionID).isModuleAllowed("FRM_ADMIN_JOURNEY_ADD"));
					...
					jButtonAdd.setBounds(330, 41, 126, 32);
...

				{
					...
					jStatusText.setBounds(0, 607, 511, 21);
...

				{
					...
					jButtonExcel.setBounds(457, 41, 126, 32);
...

				{
					...
					calendarButtonexpiryFrom.setEnabled(false);
					calendarButtonexpiryFrom.setBounds(281, 153, 21, 21);
					jDesktopPane1.add(calendarButtonexpiryFrom);
				}
				{
					calendarButtonexpiryTo = new JCalendarButton(timeslotTo);
					calendarButtonexpiryTo.setEnabled(false);
					calendarButtonexpiryTo.setBounds(502, 153, 21, 21);
					jDesktopPane1.add(calendarButtonexpiryTo);
				}
				{
					JButton4j jButtonDelete = new JButton4j(Common.icon_delete);
					jButtonDelete.setEnabled(
							Common.userList.getUser(Common.sessionID).isModuleAllowed("FRM_ADMIN_JOURNEY_DELETE"));
					...
					jButtonDelete.setBounds(330, 71, 126, 32);
				...
				
				{
					...
					label4j_std.setBounds(12, 77, 113, 21);
					jDesktopPane1.add(label4j_std);
					
					jTextFieldLocationID.setBounds(132, 77, 139, 23);
					...
					button4j_LocationLookup.setBounds(279, 77, 21, 21);
				...
				
				{
					...
					jButtonClear.setBounds(457, 11, 126, 32);
...

					{
						...
						jSpinnerLimit.setBounds(434, 190, 68, 21);
